...
*- in main.tex comment out 'digitalVersion'
*- wrap \ifdigitalVersion \else around whatever needs to be removed for print
...
*CLOSED: [2022-02-13 Sun 18:37]
* DONE TeX: how to add parameters to "digitalVersion" to toggle on/off certain features
...
*CLOSED: [2022-02-13 Sun 18:38]
* DONE TeX: digitalverison conditionals
*CLOSED: [2022-02-23 Wed 10:00]
...
* DONE TeX: double check twoside setting for nondigitalversion, alterations to margins may have disturbed this
*CLOSED: [2022-02-25 Fri 22:51]
...
* TODO funeral, protection, thanksgiving start on new page
** TODO check thai references afterwards
...
* TODO split tex directory into two for a6 and a*?
* TODO write a script that will copy all WPN endnotes and one that will wrap them all with conditionals
