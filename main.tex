...
% TODO is an else argument needed for non e/desktop?
% TODO do printed documents need images to be within the pdf or should these be handles separately?

\ifdesktopversion
  \desktopCover{\includegraphics[height=\paperheight]{./assets/title-pages/A6/front-cover.jpg}}
\fi
...
% TODO is an else argument needed for non desktop/desktop?
