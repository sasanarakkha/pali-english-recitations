...
\cleartoverso
  \includepdf[pages=-,pagecommand={\thispagestyle{empty}}]{assets/graphics/civara_9x13.pdf}
\fi

\ifbfiveversion
  \photoFullBleed{./assets/illustrations/B5/front_cover_B5.jpg}
\cleartoverso
  \includepdf[pages=-,pagecommand={\thispagestyle{empty}}]{assets/graphics/civara_B5.pdf}
\fi
...
\ifbfiveversion
  \includepdf[pages=-,pagecommand={\thispagestyle{empty}}]{assets/graphics/donor-list.pdf}
  \newpage
  \thispagestyle{empty}
  \null
  \newpage
