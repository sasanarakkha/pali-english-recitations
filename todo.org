...
** TODO increase font size of set navigation hub
** TODO tweak Makefile to automatically install inotify-tools,calibre, and sigil
** TODO test conditional around WPN endnotes
** TODO add creative commons page to ebook
** TODO funeral, protection start on new page
*** TODO check thai references afterwards
** TODO add puncutation to bhavatu at the end of funeral. also check epub.
** TODO look at epub dependent origination
** TODO convert fancy quotes to html codes
