...
** TODO TeX: yatha-vari-vaha title closer than subsequent titles
** TODO TeX: fix indentation for pali-hang and pali-hangtogether
** TODO TeX: return periods in cardinal suttas
** TODO TeX: check for endnotes that are too close to proceeding word
** TODO TeX: check spacing of parittas
** TODO TeX: document anecdote and local
** TODO TeX: trim the fat: remove unneeded code, directories, and files
** TODO HTML: reduce space between leader intro and first line, create style
** TODO Add footnote for 'right livelihood' that defines the meaning
** TODO remove empty pages
** TODO remove footnote 74
...
** TODO HTML: fix epub hyperlink order
** TODO HTML: Gradual training FN for “proper time”: The Vinaya defines the wrong time for eating as from noon until dawnrise of the following day.
** TODO TeX: footnote 50 jumping to wrong place
** DONE HTML: destructing the defilements
CLOSED: [2022-12-09 Fri 11:20]
** TODO TEX & HTML: inner serenity for second jhāna -- needs footnote
** TODO HTML: footnote for "frequently taught" and "sharing often the words of Dhamma" -- translation changed just needs footnote
** TODO HTML: bowels/entrails to intestines/mesentery and add footnote
** TODO HTML: DO ENDNOTES WHEN FINISHED
** TODO BOTH: consider a quotation mark purge
** TODO BOTH: add footnote to n8p for right livelihood
