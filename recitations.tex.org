...
% TODO why are these page breaking?
...
% TODO Only recited and Breathing are misalgined
\ifafiveversion
\begin{tabular}{@{}ll@{}}
...
\ifasixversion
\begin{tabular}{@{}ll@{}}
  \anglebracketleft\ \hspace{-0.5mm}... \hspace{-0.70mm}\anglebracketright\ & \hspace{1.0mm}Only recited by the leader \\
  \hspace{0.1cm} \abbrbreathmark\ & \hspace{1.05mm}Breathing pause \\
\end{tabular}
\fi
...
% TODO condtionalizsing these mboxes will eb painful
...
% TODO needs a hang together verses
\begin{english-verses}
...
\end{leader}
% TODO spacing below is too large?
...
\begin{english-verses}
  ...
  % TODO through all the power of the buddha, dhamam, sangha
  May you always be at ease.
\end{english-verses}
...
% TODO I removed justify from here onwards, the format will change check a6 and a5
