...
** TODO unreferenced build error results from \pdfbookmark in schedule
** DONE is 'pali-english recitations' section needed?
CLOSED: [2022-02-13 Sun 18:38]
** TODO desktopverison conditionals
- remove alternating margins
- blank pages
** TODO chapter pdf bookmarks go to 'CHAPTER' page instead of Cover page
...
- [[#task-list][Task List]]
  ...
  - [[#unreferenced-build-error-results-from-pdfbookmark-in-schedule][unreferenced build error results from \pdfbookmark in schedule]]
  ...
  - [[#chapter-pdf-bookmarks-go-to-chapter-page-instead-of-cover-page][chapter pdf bookmarks go to 'CHAPTER' page instead of Cover page]]
