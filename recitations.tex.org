...
** TODO G - unreferenced build error results from \pdfbookmark in schedule
- checked those unreferenced endnotes
...
- would prefer to go directly to cover page and remove chapter page
** TODO page number at bottom of page
** TODO G - add headers to endnotes -- find stack exchange
...
** TODO more space between pali-english leader intros
** TODO increase header body spacing for parittas
** TODO G - see headers that have extend to second line, they get too close to subtitle
** TODO diffpdf
...
- [[#todos][TODOs]]
  ...
  - [[#g---add-headers-to-endnotes----find-stack-exchange][G - add headers to endnotes -- find stack exchange]]
  ...
  - [[#g---see-headers-that-have-extend-to-second-line-they-get-too-close-to-subtitle][G - see headers that have extend to second line, they get too close to subtitle]]
  - [[#diffpdf][diffpdf]]
