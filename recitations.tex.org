...
** TODO made ToC chapter headers larger
** TODO make ToC numbers larger
** TODO make sure ToC page numbers are correct size
** TODO G - two empty pages after abbreviations
...
CLOSED: [2022-02-23 Wed 10:01]
** TODO see headers that have extend to second line, they get too close to subtitle
** TODO diffpdf
** TODO ensure english styles are flush with left margin
** TODO will have to renumber endnotes, off by 1
** TODO no page number for appendix in ToC, sections in appendix not showing "Appendix" in header
** TODO italicize all non chanted pali
** TODO replace leader [] with angled brackets
** TODO no breathmarks start a new line
** TODO regular ṭ ṇ need small caps
...
- [[#todos][TODOs]]
  ...
  - [[#make-toc-numbers-larger][make ToC numbers larger]]
...
\begin{english}
  ...
  To that triad\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``To that which is worthy''. This passage refers to the triple (\textit{taya}) gems and not just to the Saṅgha.}}}}}
  which is worthy
\end{english}
...
\begin{english}
  One who knows things as they are \breathmark\ has arisen in this world\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{``One who knows things as they are'' is an unusual translation for \textit{Tathāgata}. Also ``arisen in'' is better than ``has come into'', otherwise one might think that he has come from somewhere, already being a \textit{Tathāgata}.}}}}}\\
...
\begin{english}
  Teaching the way leading out of delusion\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{No mention of ``delusion'' in the Pāli. It could also refer to \textit{samsāra} or \textit{dukkha}.}}}}}\\
...
\begin{english}
  Sorrow lamentation pain displeasure\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``grief''}}}}}
...
\begin{english}
  In brief \breathmark\ the five aggregates of clinging are dukkha\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``In brief the five focuses of identity are dukkha''}}}}}
\end{english}
...
\begin{english}
  Attachment to volitional formations\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``Attachment to mental formations''}}}}}
\end{english}

Viññāṇūpādānakkhandho

\begin{english}
  Attachment to consciousness\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``Attachment to sense-consciousness''}}}}}
\end{english}
...
\begin{english}
  Volitional formations are impermanent\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``Mental formations are impermanent''}}}}}
\end{english}

Viññāṇaṁ aniccaṁ

\begin{english}
  Consciousness is impermanent\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``Sense-consciousness is impermanent''}}}}}
\end{english}
...
\begin{english}
  Volitional formations are not-self\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``Mental formations are not-self''}}}}}
\end{english}

Viññāṇaṁ anattā

\begin{english}
  Consciousness is not-self\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``Sense-consciousness is not-self''}}}}}
\end{english}

Sabbe saṅkhārā aniccā

\begin{english}
  All conditioned things are impermanent\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``All conditions are transient''}}}}}
\end{english}

Sabbe dhammā anattā't

\begin{english}
  All things are not-self\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``There is no self in the created or the uncreated''. While this is not a very accurate translation, it is indeed the case that the term ``sabbe dhammā'' includes the uncreated, \textit{nibbāna} (see AN 5.32).}}}}}
\end{english}

Te mayaṁ otiṇṇāmha jātiyā jarā-maraṇena

\begin{english}
  All of us are affected by birth \breathmark\ ageing and death\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``All of us are bound by birth ageing and death''}}}}}
\end{english}

Sokehi paridevehi dukkhehi domanassehi upāyāsehi

\begin{english}
  By sorrow lamentation pain displeasure\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``grief''}}}}}
  and despair\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{In Pāli, these terms are in plural form, however, for the sake recitation they are kept singular.}}}}}
\end{english}

Dukkhotiṇṇā dukkha-paretā

\begin{english}
  Affected by dukkha and afflicted by dukkha\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``All of us are bound by birth ageing and death''}}}}}
\end{english}
...
\begin{english}
  Possessing the bhikkhus'training and way of life\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``Being fully equipped with the bhikkhus'system of training''}}}}}
\end{english}
...
\begin{minipage}[b][25pt][c]{\linewidth}
  \begin{leader}
    \textbf{\vspace{0.2em}\textsc{\hyperref[schedule]{Content}\\
...
\begin{english-verses}
  What is true Dhamma and what's\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``what not'': What not is usually followed by what is similar.}}}}}
  not\\
  Will never have the same results\\
  While wrong\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``lack of Dhamma'' This translation is problematic, because a mere ``lack of Dhamma'' does not lead to rebirth in hell; otherwise all non-Buddhists would be destined to hell. In reality, it is the view and practice of ``wrong Dhamma'' that leads to hell, which is also substantiated by the Commentary, which defines ``adhamma'' as the opposite (\textit{paṭipakkha}) of true Dhamma.}}}}}
...
Na duggatiṁ gacchati dhamma-cārī\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
      \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{This line is missing in Wat Pah Nanachat chanting book.}}}}}
...
\begin{english-verses}
  ...
  Complete release from all suffering\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``from suffering''}}}}}
\end{english-verses}
...
Sabba-pāpassa akaraṇaṁ\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
      \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{There are two variations as to the sequence of these three verses. The sequence used here follows the sequence of Dhp 183 (\textit{Sabba pāpassa}...), Dhp 184 (\textit{Khantī paramaṁ}...), Dhp 185 (\textit{Anūpavādo}...). In contrast, the sequence Dhp 184, 183, 185 is commonly known as the ``\textit{Ovādapātimokkha}'', and occurs at DN 14.}}}}}
...
\begin{english-verses}
  ``All conditioned things are impermanent''\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``Impermanent are all conditioned things''}}}}}\\
  When with wisdom this is seen\\
  One feels weary of all dukkha\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{``Dukkha'' here refers to the five aggregates themselves, as explained in SN 56.11: ``The five aggregates of clinging are dukkha''. Along similar lines, the five aggregates are called ``burdens'' in SN 22.22.}}}}}\\
...
\begin{english-verses}
  ``All things are not-self''\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``Dukkha are all conditioned things''}}}}}\\
  When with wisdom this is seen\\
  One feels weary of all dukkha\\
  This is the path to purity
\end{english-verses}
...
\begin{english-verses}
  ...
  Gone from home to homelessness\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``From the floods dry land they reach''}}}}}\\
  Living withdrawn so hard to enjoy\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``Living withdrawn so hard to do''}}}}}\\
...
\begin{english-verses}
  ...
  A sage will not reach unity\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{`Unity'here refers to unity of mind due to concentration (\textit{samādhi}, \textit{cittass-ekaggatā}). \textit{Nekatta} = \textit{na} + \textit{ekatta} [abstr. fr. \textit{eka}].}}}}}
\end{english-verses}
...
\begin{english-verses}
  ...
  Dust follows upon heedlessness\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{The meaning of this statement is somewhat cryptic. The Commentary explains as follows: \textit{pamādo rajo} = heedlessness is dust; \textit{pamādo pamādānupatito rajo} = the dust that follows heedlessness is (also) heedlessness; the Commentary further explains that this is about procrastination e.g. ``I am still young, so can afford to be heedless; maybe later I'll be heedful''.}}}}}\\
...
\begin{english-verses}
  ...
  Unmoved unagitated\\
  That is what the wise would keep fostering\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``Such insight is one's strength''}}}}}
\end{english-verses}
...
\begin{english-verses}
  ...
  Day and night relentlessly\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``Thus for a night of non-decline''}}}}}\\
  That is ``a single excellent night''\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``a shining night of prosperty''}}}}}\\
...
\begin{leader-english}
  〈 Now let us recite the verses on the Highest Blessings\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{``The term ``blessing'' is used throughout this chanting book to convey the meaning of ``support'', or ``a beneficial thing'', without implying the underlying Christian connotations this term may have in popular use.}}}}} 〉
\end{leader-english}

\begin{english-only}
  Thus have I heard that the Blessed One\\
  Was dwelling at Sāvatthī\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``Was staying at Sāvatthī''}}}}}\\
...
\begin{english-only}
  Ardent and committed\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``ardent committed''}}}}}
  to the holy life\\
...
\section{\mbox{The Buddha's Words on Loving-Kindness}}
...
\begin{english-only}
  ...
  Just\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``Even''}}}}}
...
\begin{english}
  It is just this Noble Eightfold Path\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``It is this Noble Eightfold Path''}}}}}
\end{english}
...
\begin{english}
  Sickness is dukkha\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{For some reason ``\textit{byādhipi dukkho}'' is missing from the WPN version of this chanting book. The reason for this omission is unclear, because even the Thai edition of this discourse contains ``\textit{byādhipi dukkho}''. However, the definition of the four noble truths in the context of the \textit{Satipaṭṭhānasuttas} in DN and MN do not contain ``\textit{byādhipi dukkho}''. It may be that the compilers of this chanting book copy/pasted this passage from the wrong discourse, thinking it is the same anayway, whereas in reality there is this small difference.}}}}}
\end{english}
...
\begin{english}
  ...
  Discernment arose\\
  Knowledge arose\\
  Light arose in me\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``Light arose''}}}}}\\
...
\begin{english}
  This Noble Truth of dukkha\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``Now this Noble Truth of dukkha''}}}}}\\
...
\begin{english}
  ...
  With their three phases and twelve aspects\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{The three phases are comprised of the statement of the noble truth itself, followed by what is the task that is to be performed in relation to this noble truth, followed by the statement that the task has been performed. Four truths multiplied by three phases, results in 12 aspects.}}}}}\\
...
\begin{english-only-justify}
  ``Abandoning false speech \breathmark\ he abstains from false speech \breathmark\ he speaks truth \breathmark\ adheres to truth \breathmark\ is trustworthy and reliable \breathmark\ one who is no deceiver of the world. Abandoning malicious speech \breathmark\ he abstains from malicious speech \breathmark\ he does not repeat elsewhere what he has heard here \breathmark\ in order to divide those people\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: [those people]. Removed brackets for the sake of recitability.}}}}}
...
\begin{english-only-justify}
  ``After his meal on returning from almsround he sits down \breathmark\ having crossed his legs \breathmark\ sets his body erect \breathmark\ having established mindfulness in front of him. Abandoning longing\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``covetousness''}}}}}
...
\begin{english}
  Having put away\\
  Longing and grief for the world\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``covetousness and grief''}}}}}
\end{english}
...
\begin{english}
  He abides contemplating dhammas as dhammas\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``He abides contemplating mind-objects as mind-objects''. Since ``mind-object'' is not an ideal translation for ``\textit{dhamma}'' in this context, it is preferable to leave ``\textit{dhamma}'' untranslated here.}}}}}
\end{english}
...
\begin{english}
  With the previous disappearance of joy and displeasure\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``grief''}}}}}
\end{english}
...
\begin{english}
  He trains thus:\\
  `I shall breathe in tranquillizing the bodily formation'\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``I shall breathe in tranquillising the bodily formations''. \textit{Kāyasaṅkhāraṁ} is singular, not plural.}}}}}
\end{english}
...
\begin{english}
  He trains thus:\\
  `I shall breathe in tranquillizing the mental formations'\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``I shall breathe in tranquillising the mental formations''. \textit{Cittasaṅkhāraṁ} is singular, not plural.}}}}}
\end{english}
...
\end{leader}
\begin{leader-english}
  〈 Now let us recite the Analysis of Dependent Origination\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Lit.: ``the 'Discourse Analysis' from the 'Analysis of Dependent Origination'''  The ``Discourse Analysis'' is a sub-chapter (Abh.Vibh.130f) from the ``Analysis of Dependent Origination'', which is part of the 2nd book of the \textit{Abhidhammapiṭaka} called the ``\textit{Vibhaṅga}''. Apart from minor variations, there is great similarity between this analysis and the analysis found in SN 12.2, as part of the \textit{Suttapiṭaka}.}}}}} 〉
\end{leader-english}

Avijjā-paccayā saṅkhārā

\begin{english}
  From ignorance as a\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Here and at other places of the English translation, the term ``a condition'' is used. The indefinite article ``a'' indicates, that there could be other conditions as well (e.g. all previous conditions in the sequence are a condition for all subsequent ones), but the directly aforementioned condition is the predominant one (\textit{adhipati-paccaya}) for the subsequent conditioned thing to arise.}}}}}
  condition arise\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Here and at other places of the English translation, the term ``arises'' is inserted, because the term ``\textit{sambhavati}'' from ``\textit{Jāti-paccayā jarāmaraṇaṁ; soka parideva dukkha domanassupāyāsā sambhavanti}'' applies to all 11 links (12 minus ignorance) and not only to ageing-and-death etc.}}}}}
  formations
\end{english}
...
\begin{english}
  From consciousness as a condition arises name-and-form\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{In the context of dependent origination, the compound ``\textit{nāmarūpa}'' is translated as ``mind-and-body'' in order to cover the entirety of what is conventionally called ``a being, a person''. In other contexts, particularly if used separately, these terms may have other connotations.}}}}}
\end{english}
...
\begin{pali-hang}
  Kāyasañcetanā kāyasaṅkhāro vacīsañcetanā vacīsaṅkhāro manosañcetanā cittasaṅkhāro\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Further explained in SN 12.25}}}}}
\end{pali-hang}

\begin{english-verses}
  Volition associated with the body is the bodily formation\\
  Volition associated with speech is the verbal formation\\
  Volition associated with the mind is the mental\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{\textit{Manosañcetanā cittasaṅkhāro} is translated here as ``volition associated with the mind is the mental formation''. Despite of mano and citta having in certain contexts different shades of meaning, both were translated here as ``mind''. Generally speaking mano refers more to the intellectual, whereas citta covers more the emotional/affective aspects of the mind. A detailed analysis of these terms can be found in Rune E. A. Johansson's ``\textit{Citta, Mano, Viññāṇa — a Psychosemantic Investigation}''.}}}}}
  formation
\end{english-verses}
...
\begin{pali-hang}
  Yā tesaṁ tesaṁ sattānaṁ tamhi tamhi sattanikāye jāti \breathmark\ sañjāti okkanti abhinibbatti khandhānaṁ pātubhāvo āyatanānaṁ paṭilābho\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{While SN 12.2 does not contain a full elaboration on all types of \textit{dukkha}, a similar analysis is found in DN 22.}}}}}
\end{pali-hang}
...
\begin{english}
  Gotamī\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Anglicising of Pāli words is quite arbitrary. For masc. and neuter we use the stem, but for fem. we use the nominative, wherefore \textit{Gotami} (voc.) becomes \textit{Gotamī}.}}}}}
...
\begin{english}
  ...
  By manly strength\\
  By manly energy\\
  By manly effort\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``By human strength/energy/effort''; while purisa can also mean person, or human, in this context it probably refers to the feature of strength, which is typically associated with masculinity. A similar analogy occurs with the expression of a strong man (\textit{purisa}) extending or contracting his arm (AN 7.61).}}}}}\\
...
\begin{english}
  Well withdrawn from evil\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: omitted ``evil'' (\textit{pāpa}) in its translation.}}}}}
  unwholesome states
\end{english}
...
\begin{english}
  Bhikkhus this holy life is like cream from milk\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``like the cream of the milk''; \textit{maṇḍapeyya} is a Pāli idiom, meaning `of the best quality (lit. to be drunk like cream)'}}}}}
\end{english}
...
Avaṅkatā avañjhā\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
      \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``avaññā''}}}}}
bhavissati

\begin{english}
  Thinking thus:\\
  ``Our going forth will not be crooked and barren\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``thinking in such a way: our going forth will not be barren''}}}}}
\end{english}
...
\begin{english}
  ...
  Almsfood\\
  Lodgings\\
  Supports for the sick and medicinal requisites\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``And supports for the sick''}}}}}\\
...
Alam-eva appamādena sampādetun'ti\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
      \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``sampādetun''}}}}}
...
\begin{english}
  Conditioned things are of ceasing nature\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``Change is the nature of conditioned things''}}}}}
\end{english}
...
\begin{english-verses}
  ...
  \begin{english-hangtogether}
    And may they not be parted from the good fortune they have attained\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
          \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{In the original version, this line is followed by ``When they act upon intention'', which is not found in the Pāli, and is potentially misleading, giving the implication that intention alone is not enough to count as kamma.}}}}}
  \end{english-hangtogether}
\end{english-verses}

\begin{english-verses}
  All beings are the owners of their kamma\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``All beings are the owners of their action and inherit its results. Their future is born from such action, companion to such action, and its results will be their home. All actions with intention, be they skilful or harmful, of such acts they will be the heirs.'' For the sake of consistency with other chants within this chanting book, the original version was substituted with the one found in the ``Five subjects for frequent recollection'', and ``Ten subjects for frequent recollection by one who has gone forth''.}}}}}\\
...
\begin{english-hang}
  I will abide pervading one quarter with a heart imbued with empathetic joy\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``a heart imbued with gladness''}}}}}
\end{english-hang}
...
\begin{english}
  ...
  Either skillful or harmful\\
  Of such acts \breathmark\ I will be the heir\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: `For good or for ill, Of that I will be the heir' For the sake of consistency with other passages which were translated differently, that translation has been chosen.}}}}}
\end{english}
...
\begin{english-hang}
  Bhikkhus there are these ten dhammas\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``Bhikkhus there are ten dhammas''}}}}}
...
\begin{english}
  ``I have reached a state of castelessness''\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``I am no longer living according to worldly aims and values''}}}}}
  \begin{english-hangtogether}
...
\begin{english}
  ``Now my conduct should be different from before''\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: `I should strive to abandon my former habits'}}}}}
  \begin{english-hangtogether}
    This should be reflected upon again and again by one who has gone forth
  \end{english-hangtogether}
\end{english}
...
\begin{english}
  ...
  Either skillful or harmful\\
  Of such acts \breathmark\ I will be the heir''\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``For good or for ill, Of that I will be the heir`` For the sake of consistency with other passages which were translated differently, this translation has been chosen.}}}}}
  \begin{english-hangtogether}
    This should be reflected upon again and again by one who has gone forth
  \end{english-hangtogether}
\end{english}
...
{\centering
  ...
  \begin{tabular}{ r l }
    ...
    muttaṁ          & \tr{urine} \\
    matthaluṅgan'ti & \tr{brain}\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
                      \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{In the discourses, except for one occasion in the Khp, the brain is not mentioned as a separate organ or body part, making it a list of only 31 body parts.}}}}}\\
  \end{tabular}
...
\begin{english}
  All things are not-self\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``Everything is void of self''}}}}}
\end{english}
...
\begin{english}
  Useless\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``Completely void of use''}}}}}
\end{english}
...
\begin{english}
  Their nature is to rise and cease\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: ``Their nature is to rise and fall''}}}}}
\end{english}
...
\begin{english-only-hang}
  On one occasion\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{The entire original version of the English translation has been replaced.}}}}}
  the Blessed One was dwelling at Benares \breathmark\ in the Deer Park at Isipatana. There he addressed the bhikkhus of the group of five: ``Bhikkhus'' – ``Venerable Sir'' they replied. The Blessed One said this:\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{The following passage is absent in the Thai edition of the \textit{Tipiṭaka}: “'Bhikkhus' – 'Venerable Sir', they replied. The Blessed One said this:”}}}}}
...
\begin{english-only-hang}
  On one occasion\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{The entire original version of the English translation has been replaced.}}}}} the Blessed One was dwelling at Gayā \breathmark\ at Gayā's Head \breathmark\ together with a thousand bhikkhus. There he addressed the bhikkhus:
\end{english-only-hang}
...
\begin{english}
  Likewise what's been given here\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: “So will what’s here been given”}}}}}
\end{english}

Petānaṁ upakappati

\begin{english}
  Benefits the departed ones\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: “Bring blessings to departed spirits”}}}}}
\end{english}
...
Maṇi joti-raso yathā\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
      \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{When chanted for laypeople, the first part of this chant, until here, is recited only by the \textit{Saṅghatthera}.}}}}}

\begin{english}
  Or like a bright and shining gem\\
\end{english}

Sabb'ītiyo vivajjantu\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
      \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{When chanted for laypeople, this line is recited only by the secondmost senior monk. Subsequently, the remainder of the Saṅgha joins in.}}}}}
...
\begin{pali-hang-continued}
  ...
  Maṇi joti-raso yathā\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{When chanted for laypeople, the first part of this chant, until here, is recited only by the Saṅghatthera.}}}}}
...
\begin{pali-hang-continued}
  Sabb'ītiyo vivajjantu\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{This line is recited only by the secondmost senior monk. Subsequently, the remainder of the Saṅgha joins in.}}}}}\\
  Sabba-rogo vinassatu\\
  Mā te bhavatv-antarāyo\\
  Sukhī dīgh'āyuko bhava
\end{pali-hang-continued}
...
\begin{pali-hang-continued}
  ...
  Niccaṁ vuḍḍhāpacāyino\\
  Cattāro dhammā vaḍḍhanti\\
  Āyu vaṇṇo sukhaṁ balaṁ\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{In the Thai tradition, a long pause is made after “\textit{sukhaṁ}”, and “\textit{balaṁ}” is recited in a slow and drawn-out manner.}}}}}
\end{pali-hang-continued}
...
Paṭibhānañca pañcamaṁ\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
      \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{The first four lines were composed by Āyasmā Aggacitta, functioning as an introduction to the chant.}}}}}\\
Āyu-do bala-do dhīro\\
Vaṇṇa-do paṭibhāṇa-do\\
Sukhassa dātā medhāvī\\
Sukhaṁ so adhigacchati\\
Āyuṁ datvā balaṁ vaṇṇaṁ\\
Sukhañ-ca paṭibhāna-kaṁ\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
      \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: “paṭībhāna-do”}}}}}\\
...
Pharitvāna\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
      \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{The “Invitation to the Devas” is traditionally performed as a solo introduction by the thirdmost senior monk. However, any monk who has been invited by the \textit{Saṅghatthera} can do.}}}}}
...
Dhammassavana-kālo ayam-bhadantā\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
      \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{When chanted for laypeople, only the 2nd line (\textit{Dhammassavana kālo}...) is recited, which is repeated three times.}}}}}\\
Saṅgha-payirupāsana-kālo ayam-bhadantā\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
      \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: “Payirūpāsana”. Pari+upa=payirupa}}}}}
...
Sabbe devā anumodantu\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
      \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: “devānumodantu”}}}}}
...
Paṇīdhi te padakkhiṇe\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
      \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Orig: “paṇidhi” and “padakkhiṇā”}}}}}\\
...
\begin{pali-hang-continued}
Bā-vīsat'indriyāni:\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
      \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{While these faculties are mentioned as a set of 22 only in the Abhi. Vibh., all of them are also found within the discourses.}}}}} cakkhu'ndriyaṁ sot'indriyaṁ ghān'indriyaṁ jivh'indriyaṁ kāy'indriyaṁ man'indriyaṁ itth'indriyaṁ puris'indriyaṁ jīvit'indriyaṁ sukh'indriyaṁ dukkh'indriyaṁ somanass'indriyaṁ domanass'indriyaṁ upekkh'indriyaṁ saddh'indriyaṁ viriy'indriyaṁ sat'indriyaṁ samādh'indriyaṁ paññ'indriyaṁ anaññātañ-ñassāmīt'indriyaṁ aññ'indriyaṁ aññātāv'indriyaṁ.
\end{pali-hang-continued}
...
\begin{english}
  ...
  The sun and the moon \breathmark\ and all virtuous leaders of the world\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{While the celestial bodies themselves are not regarded as living beings, this passage refers to the similarly named young devas (\textit{candimā}/\textit{sūriyo devaputto}) residing there. See also SN 2.9-10. Furthermore, the term “\textit{rārā}” (leaders/kings) does not refer to “\textit{guṅavantā}” (virtuous people), but to “\textit{suriyo candima}” (sun and moon). A translation closer to the meaning of the Pāli would be: “The sovereign Sun and Moon, and also virtuous people.”}}}}}\\
  ...
  May they soon attain the threefold bliss\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{This probably refers to  1. worldly or human happiness; 2. celestial or heavenly happiness; 3. transcendent happiness or \textit{Nibbāna}. Rhys Davids Pāli-English Dictionary - \textit{sukha}: “Two kinds, viz \textit{kāyika} \& \textit{cetasika}; at Pts.i.188; several other pairs at AN.i.80; three (praise, wealth, heaven) Iti.67; another three (\textit{manussa}°, \textit{dibba}°, \textit{nibbāna}°) Dhp-a.iii.51; four (possessing, making good use of possessions, having no debts, living a blameless life) AN.ii.69”}}}}}
  ...
  May the forces of delusion\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{The Pāli speaks about Māra's forces.}}}}}
  not take hold \breathmark\ nor weaken my resolve\\
  The Buddha is my excellent refuge\\
  Unsurpassed is the protection of the Dhamma\\
  The Solitary Buddha is my noble guide\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{Even though a \textit{Paccekabuddha} does not/is not able to teach the path to \textit{Nibbāna}, he can nonetheless give guidance in good conduct and virtue; Functioning as an inspirational role model.}}}}}\\
  The Saṅgha is my supreme support\\
  Through the supreme power of all these\\
  May darkness and delusion be dispelled\hyperlink{endnote1-appendix}{\hypertarget{endnote1-body}{\pagenote{%
        \hypertarget{endnote1-appendix}{\hyperlink{endnote1-body}{“Darkness and delusion” is not a literal translation for Māra.}}}}}
\end{english}
