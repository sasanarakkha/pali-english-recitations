...

{
  ...
  {\centering
    ...
    \begin{center}
      ...
      \ifninebythirteenversion \includegraphics[height=24mm]{sbs_logo_tuck_loon_brown.jpg}\fi
...
\ifninebythirteenversion
  \chapterOpeningPage{homage_to_the_triple_gem_9x13.jpg}
\fi

\ifbfiveversion
  \chapterOpeningPage{homage_to_the_triple_gem_B5.jpg}
\fi

\chapter{Homage to the Triple Gem}

\ifbfiveversion
  \includepdf[pages=2]{assets/graphics/civara_b5.pdf}
\fi

\ifninebythirteenversion
  \includepdf[pages=2]{assets/graphics/civara_9x13.pdf}
\fi
...
\ifninebythirteenversion
  \chapterOpeningPage{verses_9x13.jpg}
\fi

\ifbfiveversion
  \chapterOpeningPage{verses_B5.jpg}
\fi
...
\begin{english-only-justify}
  ``It is possible to describe a gradual training \breathmark\ gradual practice \breathmark\ and gradual progress in this Dhamma and Vinaya. When the Tathāgata obtains a person to be tamed \breathmark\ he first disciplines him thus:
\end{english-only-justify}
...
\begin{english-only-justify}
  ``He abstains from harming seeds and plants. He practices eating one meal a day \breathmark\ abstaining from eating at night and outside the proper time.\makeatletter\hyperlink{endnote148-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote148-appendix}{\hyperlink{endnote148-body}{The \textit{Vinaya} defines the wrong time for eating as from noon until dawnrise of the following day.}}}}}\makeatother\thinspace He abstains from dancing \breathmark\ singing \breathmark\ music and seeing entertainments. He abstains from wearing \mbox{garlands}~\breathmark\ smartening himself with scent \breathmark\ and embellishing himself with unguents. He abstains from high and luxurious sleeping places. He abstains from accepting gold and silver. He abstains from accepting raw grain. He abstains from accepting raw meat. He abstains from accepting women and girls. He abstains from accepting men and women slaves. He abstains from accepting goats and sheep. He abstains from accepting fowl and pigs. He abstains from accepting \mbox{elephants}~\breathmark\ cattle \breathmark\ horses and mares. He abstains from accepting fields and land.''
\end{english-only-justify}
...
\begin{english-only-justify}
  ``After his meal on returning from almsround he sits down \breathmark\ having crossed his legs \breathmark\ sets his body erect \breathmark\ having established mindfulness in front of him. Abandoning longing \ifdigitalversion\makeatletter\hyperlink{endnote61-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-only-justify}
  ``When these five hindrances are unabandoned in himself \breathmark\ he sees them respectively as a debt \breathmark\ a disease \breathmark\ a prison \breathmark\ \mbox{slavery}~\breathmark\ and a road across a desert. But when these five hindrances have been abandoned in \mbox{himself}~\breathmark\ he sees that as freedom from \mbox{debt}~\breathmark\ freedom from \mbox{disease}~\breathmark\ release from prison \breathmark\ freedom from slavery \breathmark\ and a land of safety. Considering thus he would be glad and full of joy.''
\end{english-only-justify}
...
\ifninebythirteenversion
  \chapterOpeningPage{reflections_9x13.jpg}
\fi

\ifbfiveversion
  \chapterOpeningPage{reflections_B5.jpg}
\fi
...
\ifninebythirteenversion
  \chapterOpeningPage{protective_recitations_9x13.jpg}
\fi

\ifbfiveversion
  \chapterOpeningPage{protective_recitations_B5.jpg}
\fi
...
\ifninebythirteenversion
  \chapterOpeningPage{funeral_recitations_9x13.jpg}
\fi

\ifbfiveversion
  \chapterOpeningPage{funeral_recitations_B5.jpg}
\fi
...
\begin{pali-hang-continued}
  Aṭṭhārasa dhātuyo:
  \begin{pali-hang}
    Cakkhu-dhātu rūpa-dhātu cakkhu-viññāṇa-dhātu sota-dhātu sadda-dhātu sota-viññāṇa-dhātu ghāna-dhātu gandha-dhātu ghāna-viññāṇa-dhātu \ifafiveversion\clearpage\fi jivhā-dhātu rasa-dhātu jivhā-viññāṇa-dhātu \ifbfiveversion\clearpage\fi kāya-dhātu phoṭṭhabba-dhātu kāya-viññāṇa-dhātu mano-dhātu dhamma-dhātu mano-viññāṇa-dhātu
  \end{pali-hang}
\end{pali-hang-continued}
