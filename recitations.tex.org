...
\begin{english-verses}
  ...
  A third time, to the Saṅgha I go for refuge.\makeatletter\hyperlink{endnote146-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote146-appendix}{\hyperlink{endnote146-body}{This chant has been referenced as traditional because there is no direct correlative. The closest would be the stock phrase of a newly acquired lay follower:  MN 26  }}}}}\makeatother
\end{english-verses}
