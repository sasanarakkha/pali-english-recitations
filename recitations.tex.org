...
\begin{leader-only}
  \anglebracketleft\ \hspace{-0.5mm}Bhikkhus what do you think: \hspace{-0.5mm}\anglebracketright\
\end{leader-only}
...
\begin{leader-only}
  \anglebracketleft\ \hspace{-0.5mm}Therefore bhikkhus \hspace{-0.5mm}\anglebracketright\
\end{leader-only}
...
\begin{leader-only}
  \anglebracketleft\ \hspace{-0.5mm}Bhikkhus when a noble disciple \hyperlink{endnote110-appendix}{\hypertarget{endnote110-body}{\pagenote{%
...
\begin{leader-only}
  \anglebracketleft\ \hspace{-0.5mm}Bhikkhus when a noble disciple \hspace{-0.5mm}\anglebracketright\
\end{leader-only}
...
\begin{leader-only}
  \anglebracketleft\ \hspace{-0.5mm}Pañcakkhandhā: \hspace{-0.5mm}\anglebracketright\
\end{leader-only}
