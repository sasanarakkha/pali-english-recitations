...
\begin{justify}
  Long \textbf{vowels} have the sound indicated above but are held for a second beat. The vowels \textbf{e} and \textbf{o} are similiar to German language... Bhante fill in more here.
\end{justify}
