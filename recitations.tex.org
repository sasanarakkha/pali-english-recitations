...

{
  ...
  {\centering
    ...
    \begin{center}
      \ifafiveversion \includegraphics[height=54mm]{sbs_logo_tuck_loon_brown.jpg} \fi
      \ifninebythirteenversion \clearpage \vspace*{\fill}
 \includegraphics[height=80mm]{sbs_logo_tuck_loon_brown.jpg} \vspace*{\fill} \fi
      \ifbfiveversion \vspace{1cm} \includegraphics[height=70mm]{sbs_logo_tuck_loon_brown.jpg}\fi
    \end{center}
  }
}
...
{\centering
  ...
  \textsc{\ifafiveversion\fontsize{14.4}{28}\fi\ifninebythirteenversion\fontsize{8.7}{17}\fi\ifbfiveversion\fontsize{16}{33.5}\fi\selectfont
    ...
    \hyperref[wheel-of-dhamma-abridged]{Turning the Wheel of Dhamma} \ifdigitalversion\else\pageref{wheel-of-dhamma-abridged}\fi\\
    ...
    \hyperref[uddissanadhitthana]{Sharing and Aspirations (Pāli)} \ifdigitalversion\else\pageref{uddissanadhitthana}\fi\\
  ...
  \textsc{\ifafiveversion\fontsize{14.4}{28}\fi\ifninebythirteenversion\fontsize{8.7}{17}\fi\ifbfiveversion\fontsize{16}{33.5}\fi\selectfont
    ...
    \hyperref[sharing-aspirations]{Sharing and Aspirations (English)} \ifdigitalversion\else\pageref{sharing-aspirations}\fi\\
...
\textsc{\ifafiveversion\fontsize{14.4}{28}\fi\ifninebythirteenversion\fontsize{8.7}{17}\fi\ifbfiveversion\fontsize{16}{33.5}\fi\selectfont
    ...
    \hyperref[sharing-merits-departed]{Sharing of Merits with \ifninebythirteenversion\\[-0.6em]\fi the Departed (Pāli-English)} \ifdigitalversion\else\pageref{sharing-merits-departed}\fi\\
    \hyperref[sharing-merits-devas]{Sharing of Merits with the Devas (Pāli-English)} \ifdigitalversion\else\pageref{sharing-merits-devas}\fi\\
    \hyperref[closing-homage]{Closing Homage (Pāli-English)} \ifdigitalversion\else\pageref{closing-homage}\fi\\
  }
...
\textsc{\ifafiveversion\fontsize{14.4}{28}\fi\ifninebythirteenversion\fontsize{8.7}{17}\fi\ifbfiveversion\fontsize{16}{33.5}\fi\selectfont
    ...
    \hyperref[just-as-rivers]{Thanksgiving Recitations} \ifdigitalversion\else\pageref{just-as-rivers}\fi\\
    \hyperref[sharing-all-merits]{Sharing of All Merits} \ifdigitalversion\else\pageref{sharing-all-merits}\fi\\
    \hyperref[closing-homage]{Closing Homage (Pāli-English)} \ifdigitalversion\else\pageref{closing-homage}\fi\\
  }}
...
\begin{english}
  I render homage to the Buddha the Blessed One \hfill{\textnormal{\ifafiveversion\fontsize{12.5}{18}\fi\ifninebythirteenversion\fontsize{9}{13}\fi\selectfont (Bow)}}
\end{english}
...
\begin{english}
  I bow to the Dhamma \hfill{\textnormal{\ifafiveversion\fontsize{12.5}{18}\fi\ifninebythirteenversion\fontsize{9}{13}\fi\selectfont (Bow)}}
\end{english}
...
\begin{english}
  I bow to the Saṅgha \hfill{\textnormal{\ifafiveversion\fontsize{12.5}{18}\fi\ifninebythirteenversion\fontsize{9}{13}\fi\selectfont (Bow)}}
\end{english}
...
\begin{english}
  ...
  I bow my head to the Blessed One \hfill{\textnormal{\ifafiveversion\fontsize{12.5}{18}\fi\ifninebythirteenversion\fontsize{9}{13}\fi\selectfont (Bow)}}
\end{english}
...
\begin{english}
  ...
  I bow my head to this truth \hfill{\textnormal{\ifafiveversion\fontsize{12.5}{18}\fi\ifninebythirteenversion\fontsize{9}{13}\fi\selectfont (Bow)}}
\end{english}
...
\begin{verses}
  ...
  Na duggatiṁ gacchati dhamma-cārī\ifdigitalversion\makeatletter\hyperlink{endnote31-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-verses}
  ...
  Complete release from all suffering\ifdigitalversion\makeatletter\hyperlink{endnote32-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-verses}
  Whoever goes for refuge\ifdigitalversion\makeatletter\hyperlink{endnote162-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote162-appendix}{\hyperlink{endnote162-body}{WPN: ``Whoever goes to refuge''}}}}}\makeatother\fi\\
  To the Buddha the Dhamma and the Saṅgha\ifdigitalversion\makeatletter\hyperlink{endnote163-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-verses}
  ``All conditioned things are impermanent''\ifdigitalversion\makeatletter\hyperlink{endnote34-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-verses}
  ``All things are not-self''\ifdigitalversion\makeatletter\hyperlink{endnote36-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-verses}
  ...
  Gone from home to homelessness\ifdigitalversion\makeatletter\hyperlink{endnote37-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-verses}
  ...
  The beast of burden is the person\ifdigitalversion\makeatletter\hyperlink{endnote39-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-verses}
  ...
  The dust of defilements all the more\ifdigitalversion\makeatletter\hyperlink{endnote41-appendix}\Hy@raisedlink{{\pagenote{%
...
\ifbfiveversion\enlargethispage{1.5\baselineskip}\fi
...
\end{pali-hang-verses}
\begin{pali-hang-together}
  Asaṁhiraṁ asaṅkuppaṁ – Taṁ vidvā\ifdigitalversion\makeatletter\hyperlink{endnote156-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-verses}
  ...
  Unmoved unagitated\\
  That is what the wise would keep fostering\ifdigitalversion\makeatletter\hyperlink{endnote43-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-verses}
  ...
  Day and night relentlessly\ifdigitalversion\makeatletter\hyperlink{endnote44-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote44-appendix}{\hyperlink{endnote44-body}{WPN: ``Thus for a night of non-decline''}}}}}\makeatother\fi\\
  That is ``a single excellent night''\ifdigitalversion\makeatletter\hyperlink{endnote45-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-only}
  ...
  Was dwelling at Sāvatthī\ifdigitalversion\makeatletter\hyperlink{endnote47-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-only}
  ...
  And ways of work that are burden-free\ifdigitalversion\makeatletter\hyperlink{endnote155-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-only}
  ...
  And hearing the Dhamma at suitable times\ifdigitalversion\makeatletter\hyperlink{endnote151-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-only}
  ...
  And discussing the Dhamma at suitable times\ifdigitalversion\makeatletter\hyperlink{endnote151-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote151-appendix}{\hyperlink{endnote151-body}{WPN: ``And sharing often the words of Dhamma''}}}}}\fi\\
  These are the highest blessings
\end{english-only}

\ifbfiveversion\enlargethispage{1\baselineskip}\fi

\linkdest{endnote48-body}
\begin{english-only}
  Ardent and committed \ifdigitalversion\makeatletter\hyperlink{endnote48-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-only}
  ...
  Just\ifdigitalversion\makeatletter\hyperlink{endnote49-appendix}\Hy@raisedlink{{\pagenote{%
  ...
  By not holding wrong views\ifdigitalversion\makeatletter\hyperlink{endnote50-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  It is just this Noble Eightfold Path\ifdigitalversion\makeatletter\hyperlink{endnote51-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  Sickness is dukkha\ifdigitalversion\makeatletter\hyperlink{endnote52-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  In brief \breathmark\ the five aggregates of clinging are dukkha\ifdigitalversion\makeatletter\hyperlink{endnote54-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-verses}
  ...
  \ifbfiveversion\enlargethispage{1\baselineskip}\fi
  Light arose in me\ifdigitalversion\makeatletter\hyperlink{endnote55-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  This Noble Truth of dukkha\ifdigitalversion\makeatletter\hyperlink{endnote56-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-only-justify}
  ``After his meal on returning from almsround he sits \mbox{down}~\breathmark\ having crossed his legs \breathmark\ sets his body erect \breathmark\ having established mindfulness in front of him. Abandoning longing \ifdigitalversion\makeatletter\hyperlink{endnote61-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  Having put away\\
  Longing and grief for the world\ifdigitalversion\makeatletter\hyperlink{endnote62-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  He abides contemplating dhammas as dhammas\ifdigitalversion\makeatletter\hyperlink{endnote63-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  And experiencing pleasure with the body\ifdigitalversion\makeatletter\hyperlink{endnote65-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  With the previous disappearance of joy and displeasure\ifdigitalversion\makeatletter\hyperlink{endnote67-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  ...
  `I shall breathe in tranquillizing the bodily formation'\ifdigitalversion\makeatletter\hyperlink{endnote68-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  ...
  `I shall breathe in experiencing the mental formation'\ifdigitalversion\makeatletter\hyperlink{endnote69-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  ...
  `I shall breathe in tranquillizing the mental formation'\ifdigitalversion\makeatletter\hyperlink{endnote70-appendix}\Hy@raisedlink{{\pagenote{%
...
\ifdigitalversion\bottomNav{discourse-on-blessings}\fi
...
\begin{english-verses}
  ...
  By manly effort\ifdigitalversion\makeatletter\hyperlink{endnote87-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  Well withdrawn from evil \ifdigitalversion\makeatletter\hyperlink{endnote88-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  Bhikkhus this holy life is like cream from milk\ifdigitalversion\makeatletter\hyperlink{endnote89-appendix}\Hy@raisedlink{{\pagenote{%
...
Avaṅkatā avañjhā \ifdigitalversion\makeatletter\hyperlink{endnote90-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  ...
  ``Our going forth will not be crooked and barren\ifdigitalversion\makeatletter\hyperlink{endnote91-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-verses}
  ...
  Supports for the sick and medicinal requisites\ifdigitalversion\makeatletter\hyperlink{endnote92-appendix}\Hy@raisedlink{{\pagenote{%
...
Alam'eva appamādena sampādetun'ti\ifdigitalversion\makeatletter\hyperlink{endnote93-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  Conditioned things are of ceasing nature\ifdigitalversion\makeatletter\hyperlink{endnote94-appendix}\Hy@raisedlink{{\pagenote{%
...
\ifninebythirteenversion\vspace{-0.35em}\fi
...
\begin{pali-hang}
  Saññā anattā \breathmark\ saññā ca h'idaṁ bhikkhave attā abhavissa \breathmark\ na'y'idaṁ saññā ābādhāya \mbox{saṁvatteyya}~\breathmark\ labbhetha ca \ifbfiveversion \mbox{saññāya}~\breathmark\ \else saññāya \breathmark\ \fi ``Evaṁ me saññā hotu \breathmark\ evaṁ me saññā mā ahosī''ti
\end{pali-hang}
\begin{pali-hang-together}
...
\begin{pali-hang}
  Ye keci saṅkhārā atīt'ānāgata-paccuppannā \breathmark\ ajjhattā vā bahiddhā \mbox{vā}~\breathmark\ oḷārikā vā sukhumā vā \breathmark\ hīnā vā paṇītā \mbox{vā}~\breathmark\ ye dūre santike \mbox{vā}~\breathmark\ sabbe saṅkhārā: \breathmark\ \ifninebythirteenversion\clearpage\fi ``N'etaṁ mama n'eso'ham'asmi na m'eso attā''ti \breathmark\ evam'etaṁ yathā-bhūtaṁ sammappaññāya daṭṭhabbaṁ
\end{pali-hang}
...
\end{leader-pali}
\begin{pali-hang-together}
  Sutavā ariyasāvako cakkhusmim'pi nibbindati \breathmark\ rūpesu'pi nibbindati~\breathmark\ cakkhu-viññāṇe'pi \mbox{nibbindati}~\breathmark\ cakkhu-samphasse'pi nibbindati~\breathmark\ yam'p'idaṁ cakkhu-samphassa-paccayā uppajjati vedayitaṁ \breathmark\ sukhaṁ vā dukkhaṁ vā adukkham'asukhaṁ vā \ifninebythirteenversion\enlargethispage{1\baselineskip}\fi tasmim'pi nibbindati
\end{pali-hang-together}
...
\begin{english}
  With all the power of the Buddha\ifdigitalversion\makeatletter\hyperlink{endnote169-appendix}\Hy@raisedlink{{\pagenote{%
...
\ifbfiveversion\enlargethispage{1.2\baselineskip}\fi
  Arogā sukhitā hotha\\
...
\begin{leader-pharitvana}
  ...
  \ifbfiveversion\mbox{Bhummā c'āyantu devā jala-thala-visame yakkha-gandhabba-nāgā}\\\else Bhummā c'āyantu devā jala-thala-visame yakkha-gandhabba-nāgā\\\fi
  \ifbfiveversion\mbox{Tiṭṭhantā santike yaṁ muni-vara-vacanaṁ sādhavo me suṇantu}\\\else Tiṭṭhantā santike yaṁ muni-vara-vacanaṁ sādhavo me suṇantu\\\fi
...
\begin{leader-pharitvana-english}
  ...
  \ifninebythirteenversion\mbox{Recite the protective chant with undistracted mind.}\\\else Recite the protective chant with undistracted mind.\\\fi
  Those in the heavens of sensuality \& form,\\
  On peaks \& mountain precipices,\ifninebythirteenversion\\\else\fi in palaces floating in the sky,\\
  In islands, countries, \& towns,\\
  In groves of trees \& thickets,\\
  Around homesites \& fields.\\
  \ifbfiveversion\mbox{And the earth-devas, spirits, heavenly minstrels, \& nāgas who are nearby,}\\\else And the earth-devas, spirits, heavenly minstrels,\\ \& nāgas who are nearby,\\\fi
...
\begin{pali-hang-together}
  \anglebracketleft\ \hspace{-0.5mm}Namo tassa \hspace{-0.5mm}\anglebracketright\ bhagavato arahato \ifninebythirteenversion\\ \fi sammāsambuddhassa \hfill{[3x]}
\end{pali-hang-together}
...
\ifninebythirteenversion\enlargethispage{1\baselineskip}\fi
...
\ifninebythirteenversion \vspace{-0.35cm} \suttaRef{[MJG]} \else \suttaRef{[MJG]} \fi
...
\ifafiveversion \vspace{-0.4em} \fi
...
\begin{english-verses}
  May every blessing come to be.\\
  And all good spirits guard you well.\\
  With all the power of the Buddha,\ifdigitalversion\makeatletter\hyperlink{endnote168-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-verses}
  May every blessing come to be.\\
  And all good spirits guard you well.\\
  \ifbfiveversion\enlargethispage{2\baselineskip}\fi
  \ifafiveversion\clearpage\fi
  With all the power of the Saṅgha,\\
  May you always be at ease.
\end{english-verses}
...
\begin{pali-hang-continued}
  Aṭṭhārasa dhātuyo:
  \begin{pali-hang}
    Cakkhu-dhātu rūpa-dhātu cakkhu-viññāṇa-dhātu sota-dhātu sadda-dhātu sota-viññāṇa-dhātu ghāna-dhātu gandha-dhātu ghāna-viññāṇa-dhātu \ifafiveversion\clearpage\fi jivhā-dhātu rasa-dhātu jivhā-viññāṇa-dhātu kāya-dhātu phoṭṭhabba-dhātu kāya-viññāṇa-dhātu mano-dhātu dhamma-dhātu mano-viññāṇa-dhātu
  \end{pali-hang}
\end{pali-hang-continued}
...
\begin{english-hang-verses}
  Root condition, sense-object condition, predominant condition, immediate condition, directly immediate condition, coexistent condition, reciprocity condition, dependence condition, sufficing condition, pre-existent condition, post-existent condition, repetition condition, action condition, result condition, nutriment condition, faculty condition, jhāna condition, path condition, \ifninebythirteenversion\clearpage\fi associated condition, separated condition, existence condition, non-existence condition, disappeared condition, non-dissappeared condition.
\end{english-hang-verses}
...
\ifafiveversion\vspace{-0.6em}\fi
...
\begin{english}
  ...
  \ifninebythirteenversion\end{english-hang-inline}\clearpage\fi
...
\ifafiveversion\vspace{-0.75cm}\fi
