...
TODO: sections runs past page, how to fold to second line
TODO: hyperlink text not arrow
TODO: pali subtitle smaller text
TODO: make quotes italic auto, or add manually
...
In order for a monk to be free from dependence (nissaya) on a teacher, \textit{“he must be learned and intelligent, knowing both Pāṭimokkhas … and must have been ordained as a bhikkhu for at least five years”} (Mv.I.53.5-13).\\
...
\begin{itemize}
\item Both Pātimokkhas (for the bhikkhus and bhikkhunīs).
\item The Four Bhāṇavāras — a set of auspicious chants that are still regularly memorized in Sri Lanka as the Mahā-pirit poṭha.
\item A discourse that is helpful as a guide for sermon-giving.
\item Three kinds of anumodanā (rejoicing in the merit of others) chants: for meals; for auspicious merit-making ceremonies, such as blessing a house; and for non-auspicious ceremonies, i.e. any relating to a death.
\end{itemize}
