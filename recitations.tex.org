...
** TODO remove other fonts from source files
** TODO document anecdote and local
** TODO remove unused styles
** TODO \phantomsection to english sharing and aspiration to provide link
...
- [[#task-list][Task List]]
  ...
  - [[#remove-other-fonts-from-source-files][remove other fonts from source files]]
  - [[#document-anecdote-and-local][document anecdote and local]]
  - [[#remove-unused-styles][remove unused styles]]
  - [[#phantomsection-to-english-sharing-and-aspiration-to-provide-link][\phantomsection to english sharing and aspiration to provide link]]
...
{\centering
  ...
  \phantomsection
  \addcontentsline{toc}{section}{Set 10}
