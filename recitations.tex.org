...
** TODO is the suttaRef too close?
...
- see telegram
** TODO add ToC to Index
** TODO add set section titles to schedule
** TODO remove blank pages from digital pdf (altough I don't think necessary)

** TODO add set section titles to schedule
** TODO endnotes link back, use arrow, light gray, smaller size
** TODO remove occurences of other fonts in anecdote.cls


* Table of Contents :toc:
- [[#task-list][Task List]]
  - [[#make-notes-lines-closer][make notes lines closer]]
  - [[#notes-hyperlink-back-to-location][notes hyperlink back to location]]
  - [[#endnotes-log-in-the-back-has-random-indentation-for-some-notes][endnotes log (in the back) has random indentation for some notes]]
  - [[#solve-hangindent-perhaps-manually-by-line][solve hangindent, perhaps manually by line]]
  - [[#make-conditionals-to-remeove-digital-assets-for-print][make conditionals to remeove digital assets for print]]
  - [[#make-page-number-conditional-for-schedule][make page number conditional for schedule]]
  - [[#keep-orphan-with-previous-text-use-mbox][keep orphan with previous text, use mbox?]]
  - [[#is-the-suttaref-too-close][is the suttaRef too close?]]
  ...
  - [[#add-toc-to-index][add ToC to Index]]
  - [[#add-set-section-titles-to-schedule][add set section titles to schedule]]
  - [[#remove-blank-pages-from-digital-pdf-altough-i-dont-think-necessary][remove blank pages from digital pdf (altough I don't think necessary)]]
  - [[#add-set-section-titles-to-schedule-1][add set section titles to schedule]]
  - [[#endnotes-link-back-use-arrow-light-gray-smaller-size][endnotes link back, use arrow, light gray, smaller size]]
  - [[#remove-occurences-of-other-fonts-in-anecdotecls][remove occurences of other fonts in anecdote.cls]]
...
[Thus have I heard]\pagenote{%
    The entire original version of the English translation has been replaced.}
  on one occasion the Blessed One was dwelling at Benares \breathmark\ in the Deer Park at Isipatana. There he addressed the bhikkhus of the group of five: ``Bhikkhus'' – ``Venerable Sir'' they replied. The Blessed One said this:\pagenote{%
...
\begin{english-verses}
  ...
  Benefits the departed ones\pagenote{%
    Orig: “Bring blessings to departed spirits”Orig: “Bring blessings to departed spirits”}
\end{english-verses}
...
\begin{center}
  (Repeat line by line after the leader)\pagenote{%
  The Thai tradtion recites ``Ahaṁ bhante tisaraṇena saha pañca/aṭṭha sīlāni yācāmi'' three times which translates to ``I, Venerable Sir, request the Three Refuges and the Five/Eight Precepts.'' before ``Namo tassa...''.}\\
\end{center}
