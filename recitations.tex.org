...

{
 ...
 \includegraphics[height=80mm]{sbs_logo_tuck_loon_brown.jpg} \vspace*{\fill} \fi
      \ifbfiveversion \includegraphics[height=66mm]{sbs_logo_tuck_loon_brown.jpg}\fi
    \end{center}
  }
}
...
\begin{english-only}
  Ardent and committed\ifdigitalversion\makeatletter\hyperlink{endnote48-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote48-appendix}{\hyperlink{endnote48-body}{WPN: ``ardent committed''}}}}}\makeatother \thinspace\fi
  to the holy life\\
...
\begin{english-only-hang}
  The tongue is burning \breathmark\ flavours are burning \breathmark\ tongue-consciousness is burning \breathmark\ tongue-contact is burning \breathmark\ and what is felt as pleasant or painful \breathmark\ or neither-painful-nor-pleasant \breathmark\ \ifninebythirteenversion\clearpage\fi that arises from tongue-contact as its condition \breathmark\ that too is burning
\end{english-only-hang}
\begin{english-only-hang-together}
  Burning with what?
\end{english-only-hang-together}
