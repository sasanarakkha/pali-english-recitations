...
Once again, we can see the immense emphasis that was placed on memorization and recitation, starting already during the Buddha's own ministry, and having continued all the way to the 21\textsuperscript{st} century, where we can still find monks who are able to memorize the entirety of the \textit{Tipiṭaka}.
...
\begin{verses}
  ...
  Asaṁhiraṁ asaṅkuppaṁ – Taṁ vidvā\makeatletter\hyperlink{endnote156-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote156-appendix}{\hyperlink{endnote156-body}{WPN: ``\textit{viddhā}''. The Siam edition has \textit{viddhā} (pierced) whereas the Burmese and Sri Lankan edition of the same text have \textit{vidvā} (the wise), which seems to be the variant that better conveys the intended meaning of text.}}}}} m'anubrūhaye
\end{verses}
...
\begin{english-verses}
  ...
  Accompanied by self-confidence\makeatletter\hyperlink{endnote154-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote154-appendix}{\hyperlink{endnote154-body}{The meaning of pasāda as “confidence” also finds expression in the qualities of a stream-enterer, who is declared to have aveccapasāda in the Buddha, Dhamma, and Saṅgha (AN 3.75), which Āyasmā Bodhi translates as “unwavering confidence” and Āyasmā Sujāto translates as “experiential confidence”. The qualifier ajjhatta as found in the stock formula of 2\textsuperscript{nd} Jhāna makes it into “inner/self confidence”. Alternative translations for “ajjhattaṁ sampasādanaṁ” would be “inner serenity”, “inner clarity”, “inner joy”, and it is up to the reader/reciter to reflect on these additional connotations of the term as seen fit.}}}}}\makeatother \breathmark\ and singleness of mind\\
...
\begin{leader-english-belowpali}
  \anglebracketleft\ \hspace{-0.5mm}Now let us recite the Analysis of Dependent Origination\makeatletter\hyperlink{endnote71-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote71-appendix}{\hyperlink{endnote71-body}{This chant stems mainly from “The Discourse Analysis of Dependent Origination”, which is a sub-chapter from the “The Analysis of Dependent Origination”, which is part of the 2\textsuperscript{nd} book of the \textit{Abhidhammapiṭaka} called the “\textit{Vibhaṅga}” (Abh.Vibh.130f). Apart from minor variations, there is great similarity between this analysis and the analysis found in SN 12.2, as part of the \textit{Suttapiṭaka}. The first four lines of this chant stem from SN 12.61, which functions as an illustration of the general principle of conditionality.}}}}}\makeatother \thinspace \hspace{-0.5mm}\anglebracketright\
\end{leader-english-belowpali}
...
\begin{english}
  Therein what is `karmic formations of wholesomeness'?
\end{english}
...
\begin{english}
  Therein what is `karmic formations of unwholesomeness'?
\end{english}
...
\begin{english}
  This is called `karmic formations of unwholesomeness'
\end{english}

Tattha katamo āneñj'ābhisaṅkhāro

\begin{english}
  Therein what is `karmic formations of imperturbability'?
\end{english}
...
\begin{english}
  This is called `karmic formations of imperturbability'
\end{english}
...
Maha-pphalā bhavissanti mah'ānisaṁsā
...
\end{pali-hangtogether}
\begin{pali-hangtogether}
  Yaṁ pan'āniccaṁ dukkhaṁ vipariṇāma-dhammaṁ kallaṁ nu taṁ samanupassituṁ \breathmark\ ``Etaṁ mama eso'ham'asmi eso me attā''ti?
\end{pali-hangtogether}
\begin{pali-hangtogether}
  No h'etaṁ bhante
\end{pali-hangtogether}
