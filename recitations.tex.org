a+title: SBS Pāli-English Recitations
#+author: SBS Saṅgha
#+format: LaTeX
#+startup: fold
#+auto-tangle: t
...
\begin{english-only-hang}
  And what bhikkhus is the Middle Way awakened to by the Tathāgata \breathmark\ which gives rise to \ifbfiveversion \mbox{vision}~ \else vision \breathmark\  \fi which gives rise to knowledge  which leads to peace  to direct knowledge  \mbox{to}~enlightenment~ to Nibbāna
\end{english-only-hang}
