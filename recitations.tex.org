...
** TODO reduce size of bottomnav so that it fits
...
- [[#todos][TODOs]]
  ...
  - [[#reduce-size-of-bottomnav-so-that-it-fits][reduce size of bottomnav so that it fits]]
...
\begin{english-hang}
  Clinging to sensuality \breathmark\ clinging to views \breathmark\ clinging to rules and \mbox{rituals}~\breathmark\ clinging to a sense of self\hyperlink{endnote81-appendix}{\hypertarget{endnote81-body}{\pagenote{%
