...
\begin{table}[ht]
  ...
  \resizebox{\textwidth}{!}{%
    \begin{tblr}{
        colspec={l *{11}{c}},
        hlines, vlines,
        rowsep=20pt, % Adjust vertical padding
        colsep=15pt, % Adjust horizontal padding
        row{1-5}={font=\fontsize{40}{24}\selectfont},
        cell{6-Z}{1}={font=\fontsize{40}{24}\selectfont},
        cell{6-Z}{2-12}={font=\fontsize{40}{24}\selectfont\itshape}
      }
...
% TODO B5 & A5 adjust fonts and spacing in
\begin{table}[ht]
  \centering
  \resizebox{\textwidth}{!}{%
    \begin{tblr}{
