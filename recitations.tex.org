...
\begin{english}
  With all the power of the Buddha\makeatletter\hyperlink{endnote169-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-verses}
  May every blessing come to be.\\
  And all good spirits guard you well.\\
  With all the power of the Buddha,\makeatletter\hyperlink{endnote168-appendix}\Hy@raisedlink{{\pagenote{%
