...
- [[#verses][Verses]]
  ...
  - [[#the-discourse-on-blessings][The Discourse on Blessings]]
  - [[#the-discourse-on-loving-kindness][The Discourse on Loving-Kindness]]
- [[#teachings][Teachings]]
  - [[#covertitle-2][Cover/Title]]
  - [[#turning-the-wheel-of-dhamma][Turning the Wheel of Dhamma]]
...
- [[#cardinal-discourses][Cardinal Discourses]]
  - [[#covertitle-4][Cover/Title]]
  - [[#dhammacakkappavattana-sutta][Dhammacakkappavattana-sutta]]
  - [[#the-discourse-on-turning-the-wheel-of-dhamma][The Discourse on Turning the Wheel of Dhamma]]
  ...
  - [[#the-discourse-on-the-exposition-on-burning][The Discourse on the Exposition on Burning]]
- [[#thanksgiving-recitations][Thanksgiving Recitations]]
  ...
  - [[#verses-from-the-discourse-on-confidence-in-the-supreme][Verses from the Discourse on Confidence in the Supreme]]
  - [[#verses-from-the-discourse-on-giving-at-the-proper-time][Verses from the Discourse on Giving at the Proper Time]]
...
- [[#protective-recitations][Protective Recitations]]
  ...
  - [[#passage-on-preliminary-paying-of-homage][Passage on Preliminary Paying of Homage]]
  - [[#passage-on-going-for-refuge][Passage on Going for Refuge]]
  - [[#verses-on-triumph-by-paying-homage][Verses on Triumph by Paying Homage]]
  - [[#paying-homage-to-the-octad][Paying Homage to the Octad]]
  - [[#the-discourse-on-blessings-1][The Discourse on Blessings]]
  - [[#the-discourse-on-jewels][The Discourse on Jewels]]
  - [[#the-discourse-on-the-loving-kindness-to-be-done][The Discourse on the Loving-Kindness to be Done]]
  - [[#protection-of-the-aggregates][Protection of the Aggregates]]
  - [[#qualities-of-the-buddha-dhamma-and-saṅgha][Qualities of the Buddha, Dhamma, and Saṅgha]]
  - [[#whatever-kind-of-jewel-in-the-world][Whatever Kind of Jewel in the World]]
  - [[#protection-of-the-factors-of-awakening][Protection of the Factors of Awakening]]
  - [[#protection-for-safety][Protection for Safety]]
  - [[#verses-on-dismissing-evil-spirits][Verses on Dismissing Evil Spirits]]
  - [[#verses-on-the-eight-victory-blessings][Verses on the Eight Victory Blessings]]
  - [[#protection-for-victory][Protection for Victory]]
  - [[#may-every-blessing-come-to-be][May Every Blessing Come to Be]]
- [[#funeral-recitations][Funeral Recitations]]
  - [[#covertitle-7][Cover/Title]]
  - [[#passage-on-preliminary-paying-of-homage-1][Passage on Preliminary Paying of Homage]]
  - [[#outlines-from-the-enumeration-of-phenomena][Outlines from the Enumeration of Phenomena]]
  - [[#passage-on-the-ground-for-distinct-seeing][Passage on the Ground for Distinct Seeing]]
  - [[#passage-on-the-list-from-the-foundation-of-conditional-relations][Passage on the List from the Foundation of Conditional Relations]]
  - [[#verses-starting-with-he-gave-to-me][Verses Starting with ``He Gave to Me'']]
  - [[#reflections-on-death][Reflections on Death]]
...
\chaptermark{Purpose and Benefits of Dhamma Recitation}
...
\begin{itemize}
  ...
  \item The Four \textit{Bhāṇavāras} — a set of auspicious chants, still regularly memorized in Sri Lanka as the \textit{Mahā-pirit poṭha}; one \textit{bhāṇavāra} is comprised of 8,000 syllables.
...
\ifdigital
  \chapterOpeningPage{homage_to_the_triple_gem_compressed_A5.jpg}
\else
  \chapterOpeningPage{homage_to_the_triple_gem_A5.jpg}
\fi

\ifninebythirteen
  \chapterOpeningPage{homage_to_the_triple_gem_9x13.png}
\fi

\ifbfive
  \chapterOpeningPage{homage_to_the_triple_gem_B5.png}
\fi

\chapter{Homage to the Triple Gem}

\ifninebythirteen
  \photoFullBleed{assets/images/9x13/brown_divider_9x13.pdf}
\fi
...
\begin{english-hang}
  To the Blessed One the Worthy One\ifdigital\makeatletter\hyperlink{endnote2-appendix}\Hy@raisedlink{{\pagenote{%\linebreak
...
\ifafive\clearpage\fi
\ifbfive\clearpage\fi
...
\begin{english}
  I render homage to the Buddha the Blessed One \hfill{\textnormal{\ifafive\fontsize{12.5}{18}\fi\ifninebythirteen\fontsize{9}{13}\fi\selectfont (Bow)}}
\end{english}
...
\begin{english}
  I bow to the Dhamma \hfill{\textnormal{\ifafive\fontsize{12.5}{18}\fi\ifninebythirteen\fontsize{9}{13}\fi\selectfont (Bow)}}
\end{english}
...
\begin{english}
  I bow to the Saṅgha \hfill{\textnormal{\ifafive\fontsize{12.5}{18}\fi\ifninebythirteen\fontsize{9}{13}\fi\selectfont (Bow)}}
\end{english}
...
\begin{english-hang}
  Homage to the Blessed Worthy and Perfectly Enlightened One \hfill{\textnormal{\ifafive\fontsize{12.5}{18}\fi\ifninebythirteen\fontsize{9}{13}\fi\selectfont [3x]}}
\end{english-hang}
...
\begin{english}
  Unsurpassed leader of persons to be tamed\ifdigital\makeatletter\hyperlink{endnote3-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  He has explained the holy life of complete purity\ifdigital\makeatletter\hyperlink{endnote4-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  ...
  I bow my head to the Blessed One \hfill{\textnormal{\ifafive\fontsize{12.5}{18}\fi\ifninebythirteen\fontsize{9}{13}\fi\selectfont (Bow)}}
\end{english}
...
\begin{english}
  ...
  I bow my head to this truth \hfill{\textnormal{\ifafive\fontsize{12.5}{18}\fi\ifninebythirteen\fontsize{9}{13}\fi\selectfont (Bow)}}
\end{english}
...
\begin{english}
  Who have practiced correctly\ifdigital\makeatletter\hyperlink{endnote6-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  Who have practiced properly\ifdigital\makeatletter\hyperlink{endnote7-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  The unsurpassed field of merit for the world\ifdigital\makeatletter\hyperlink{endnote149-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  ...
  I bow my head to this Saṅgha \hfill{\textnormal{\ifafive\fontsize{12.5}{18}\fi\ifninebythirteen\fontsize{9}{13}\fi\selectfont (Bow)}}
\end{english}
...
\begin{english}
  The Teaching of the Lord is like a lamp\ifdigital\makeatletter\hyperlink{endnote8-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  Divided into path and its fruit \breathmark\ the Deathless\ifdigital\makeatletter\hyperlink{endnote9-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-hang}
  And illuminating that goal \breathmark\ which is beyond the conditioned world\ifdigital\makeatletter\hyperlink{endnote10-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  ...
  To that triad\ifdigital\makeatletter\hyperlink{endnote11-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-hang}
  Sorrow lamentation pain displeasure\ifdigital\makeatletter\hyperlink{endnote14-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  In brief \breathmark\ the five aggregates of clinging are dukkha\ifdigital\makeatletter\hyperlink{endnote15-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote15-appendix}{\hyperlink{endnote15-body}{WPN: ``In brief the five focuses of identity are \textit{dukkha}''}}}}}\makeatother\fi
\end{english}
...
\begin{english}
  Attachment to volitional formations\ifdigital\makeatletter\hyperlink{endnote16-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  Attachment to consciousness\ifdigital\makeatletter\hyperlink{endnote17-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  Volitional formations are impermanent\ifdigital\makeatletter\hyperlink{endnote18-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  Consciousness is impermanent\ifdigital\makeatletter\hyperlink{endnote19-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  Volitional formations are not-self\ifdigital\makeatletter\hyperlink{endnote20-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  Consciousness is not-self\ifdigital\thinspace\makeatletter\hyperlink{endnote21-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  All conditioned things are impermanent\ifdigital\makeatletter\hyperlink{endnote22-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  All things are not-self\ifdigital\thinspace\makeatletter\hyperlink{endnote23-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  All of us are affected by birth \breathmark\ ageing and death\ifdigital\makeatletter\hyperlink{endnote24-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  By sorrow lamentation pain displeasure\ifdigital\makeatletter\hyperlink{endnote25-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  Affected by dukkha and afflicted by dukkha\ifdigital\makeatletter\hyperlink{endnote27-appendix}\Hy@raisedlink{{\pagenote{%
...
\ifninebythirteen\vspace{0.5em}\fi
...
\begin{english}
  Possessing the bhikkhus' training and way of life\ifdigital\makeatletter\hyperlink{endnote28-appendix}\Hy@raisedlink{{\pagenote{%
...
\ifdigital\bottomNav{universal-well-being}\fi
  ...
  \begin{minipage}[b][25pt][c]{\linewidth}
    \begin{leader}
      \textbf{\vspace{0.2em}\textsc{\hyperref[schedule]{Schedule}\\
          ...
          \vspace{0.5em}
          \hyperref[anatta-lakkhana]{Set 6} — \hyperref[dependent-origination]{Set 7} — \hyperref[aditta-pariyaya]{Set 8} — \hyperref[invitation-to-the-devas]{Set 9} — \hyperref[passage-on-preliminary-paying-of-homage-funeral]{Set 10}}}
    \end{leader}
  \end{minipage}
\fi
...
\ifdigital
  \chapterOpeningPage{verses_compressed_A5.jpg}
\else
  \chapterOpeningPage{verses_A5.jpg}
\fi

\ifninebythirteen
  \chapterOpeningPage{verses_9x13.png}
\fi

\ifbfive
  \chapterOpeningPage{verses_B5.png}
\fi
...
\ifdigital\bottomNav{wheel-of-dhamma-abridged}\fi
...
\begin{english-verses}
  What is true Dhamma and what's not\ifdigital\makeatletter\hyperlink{endnote29-appendix}\Hy@raisedlink{{\pagenote{%
...
\\
  ...
  While wrong \ifdigital\makeatletter\hyperlink{endnote30-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{verses}
  ...
  Na duggatiṁ gacchati dhamma-cārī\ifdigital\makeatletter\hyperlink{endnote31-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote31-appendix}{\hyperlink{endnote31-body}{This line is missing in WPN.}}}}}\makeatother\fi
\end{verses}
...
\ifdigital\bottomNav{single-excellent-night}\fi
...
\begin{english-verses}
  ...
  Complete release from all suffering\ifdigital\makeatletter\hyperlink{endnote32-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote32-appendix}{\hyperlink{endnote32-body}{WPN: ``from suffering''}}}}}\makeatother\fi
\end{english-verses}
...
\begin{english-verses}
  Whoever goes for refuge\ifdigital\makeatletter\hyperlink{endnote162-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote162-appendix}{\hyperlink{endnote162-body}{WPN: ``Whoever goes to refuge''}}}}}\makeatother\fi\\
  To the Buddha the Dhamma and the Saṅgha\ifdigital\makeatletter\hyperlink{endnote163-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote163-appendix}{\hyperlink{endnote163-body}{WPN: ``In the Triple Gem.'' It has been shown in Āyasma Aggacitta's ``Do We Go to the Triple Gem for Refuge?'' that one does not go for refuge in the Triple Gem (the Buddha, Dhamma, and Ariya-saṅgha), but the discourses repeatedly depict the Buddha, Dhamma, and Bhikkhu-saṅgha as the community to take refuge in (DN 2, MN 91, SN 12.46, AN 2.16 etc.).}}}}}\makeatother\fi\\
...
\ifdigital\bottomNav{four-great-references}\fi
...
\begin{english}
  Patient endurance is the highest austerity\ifdigital\makeatletter\hyperlink{endnote164-appendix}\Hy@raisedlink{{\pagenote{%
...
\ifdigital\bottomNav{buddhas-final-instruction}\fi
...
\begin{english-verses}
  ``All conditioned things are impermanent''\ifdigital\makeatletter\hyperlink{endnote34-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote34-appendix}{\hyperlink{endnote34-body}{WPN: ``Impermanent are all conditioned things''}}}}}\makeatother\fi\\
...
\begin{english-verses}
  ``All things are not-self''\ifdigital\makeatletter\hyperlink{endnote36-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote36-appendix}{\hyperlink{endnote36-body}{WPN: ``Dukkha are all conditioned things''}}}}}\makeatother\fi\\
...
\begin{english-verses}
  ...
  Gone from home to homelessness\ifdigital\makeatletter\hyperlink{endnote37-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote37-appendix}{\hyperlink{endnote37-body}{WPN: ``From the floods dry land they reach''}}}}}\makeatother\fi\\
  Living withdrawn so hard to enjoy\ifdigital\makeatletter\hyperlink{endnote38-appendix}\Hy@raisedlink{{\pagenote{%
...
\ifdigital\bottomNav{four-requisites}\fi
...
\ifdigital\bottomNav{respect-for-the-dhamma}\fi
...
\begin{leader}
  \anglebracketleft\ \hspace{-0.5mm}Handa mayaṁ raṭṭhapālatthera-gāthāyo \mbox{bhaṇāmase}~\hspace{-0.5mm}\anglebracketright\
\end{leader}
...
\begin{pali-hang-verses}
  Aṭṭha-pada-katā kesā\\
  Nettā añjana-makkhitā
\end{pali-hang-verses}
\begin{pali-hang-together}
  Alaṁ bālassa mohāya\\
  No ca pāragavesino
...
\ifdigital\bottomNav{parapariya}\fi
...
\begin{pali-hang-verses}
  Aññathā loka-nāthamhi\\
  Tiṭṭhante puris'uttame
\end{pali-hang-verses}
\begin{pali-hang-together}
...
\begin{pali-hang-verses}
  Sīta-vāta-parittāṇaṁ\\
  Hirikopīna-chādanaṁ
\end{pali-hang-verses}
\begin{pali-hang-together}
  Matt'aṭṭhiyaṁ abhuñjiṁsu\\
  Santuṭṭhā itar'ītare
\end{pali-hang-together}
...
\end{pali-hang-verses}
\begin{pali-hang-together}
  Yāpan'atthaṁ abhuñjiṁsu\\
  Agiddhā n'ādhimucchitā
\end{pali-hang-together}
...
\begin{pali-hang-verses}
  Araññe rukkha-mūlesu\\
  Kandarāsu guhāsu ca
\end{pali-hang-verses}
\begin{pali-hang-together}
  Vivekam'anubrūhantā\\
  Vihaṁsu tap'parāyaṇā
\end{pali-hang-together}
...
\begin{pali-hang-verses}
  ...
  Mudū atthaddha-mānasā\\
\end{pali-hang-verses}
\begin{pali-hang-together}
  Abyāsekā amukharā\\
  Atthacintā vas'ānugā
\end{pali-hang-together}
...
\begin{pali-hang-verses}
  ...
  Tesaṁ vattam'anussaraṁ
\end{pali-hang-verses}
\begin{pali-hang-together}
  Kiñ'c'āpi pacchimo kālo\\
...
\ifdigital\bottomNav{misc-verses}\fi
...
\ifdigital\bottomNav{sharing-all-merits}\fi
...
\end{pali-hang-verses}
\begin{pali-hang-together}
  Āturānañ'hi kā niddā\\
  Salla-viddhāna ruppataṁ
\end{pali-hang-together}
...
\begin{pali-hang-together}
  ...
  Maccurājā amohayittha vas'ānuge
\end{pali-hang-together}
...
\end{pali-hang-verses}
\begin{pali-hang-together}
  Tarath'etaṁ visattikaṁ\\
  Khaṇo vo mā upaccagā
\end{pali-hang-together}
\begin{pali-hang-together}
  Khaṇ'ātītā hi socanti\\
  Nirayamhi samappitā
\end{pali-hang-together}
...
\ifbfive\enlargethispage{1.5\baselineskip}\fi
...
\begin{pali-hang-verses}
  Pamādo rajo pamādo\\
  Pamād'ānupatito rajo
\end{pali-hang-verses}
\begin{pali-hang-together}
  Appamādena vijjāya\\
  Abbahe sallam'attano
\end{pali-hang-together}
...
\ifninebythirteen\enlargethispage{1\baselineskip}\fi
...
\ifninebythirteen\vspace{0.2cm}\fi
...
\ifdigital\bottomNav{highest-honour-aspirations}\fi
...
\begin{leader}
  \anglebracketleft\ \hspace{-0.5mm}Handa mayaṁ bhadd'eka-ratta-gāthāyo \mbox{bhaṇāmase}~\hspace{-0.5mm}\anglebracketright\
\end{leader}
...
\begin{pali-hang-together}
  ...
  Taṁ vidvā\ifdigital\makeatletter\hyperlink{endnote156-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{verses}
  ...
  Asaṁhiraṁ asaṅkuppaṁ – Taṁ vidvā\ifdigital\makeatletter\hyperlink{endnote156-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote156-appendix}{\hyperlink{endnote156-body}{WPN: ``\textit{viddhā}.'' The Siam edition has \textit{viddhā} (pierced) whereas the Burmese and Sri Lankan edition of the same text have \textit{vidvā} (the wise), which seems to be the variant that better conveys the intended meaning of the text.}}}}}\fi m'anubrūhaye
\end{verses}
...
\begin{english-verses}
  ...
  Unmoved unagitated\\
  That is what the wise would keep fostering\ifdigital\makeatletter\hyperlink{endnote43-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote43-appendix}{\hyperlink{endnote43-body}{WPN: ``Such insight is one's strength''}}}}}\makeatother\fi
\end{english-verses}
...
\begin{english-verses}
  ...
  Day and night relentlessly\ifdigital\makeatletter\hyperlink{endnote44-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote44-appendix}{\hyperlink{endnote44-body}{WPN: ``Thus for a night of non-decline''}}}}}\makeatother\fi\\
  That is ``a single excellent night''\ifdigital\makeatletter\hyperlink{endnote45-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote45-appendix}{\hyperlink{endnote45-body}{WPN: ``a shining night of prosperty''}}}}}\makeatother\fi\\
  So it was taught by the Peaceful Sage
\end{english-verses}

\suttaRef{[MN 131]}

\ifdigital\bottomNav{ratthapala}\fi
...
\begin{english-only}
  ...
  Was dwelling at Sāvatthī\ifdigital\makeatletter\hyperlink{endnote47-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote47-appendix}{\hyperlink{endnote47-body}{WPN: ``Was staying at \textit{Sāvatthī}''}}}}}\makeatother\fi\\
...
\begin{english-only}
  ...
  And ways of work that are burden-free\ifdigital\makeatletter\hyperlink{endnote155-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote155-appendix}{\hyperlink{endnote155-body}{WPN: ``that harm no being''}}}}}\fi\\
  These are the highest blessings
\end{english-only}
...
\begin{english-only}
  ...
  And hearing the Dhamma at suitable times\ifdigital\makeatletter\hyperlink{endnote151-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote151-appendix}{\hyperlink{endnote151-body}{WPN: ``And hearing the Dhamma frequently taught''}}}}}\fi\\
  These are the highest blessings
\end{english-only}
...
\begin{english-only}
  ...
  And discussing the Dhamma at suitable times\ifdigital\makeatletter\hyperlink{endnote151-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote151-appendix}{\hyperlink{endnote151-body}{WPN: ``And sharing often the words of Dhamma''}}}}}\fi\\
  These are the highest blessings
\end{english-only}
...
\begin{english-only}
  Ardent and committed \ifdigital\makeatletter\hyperlink{endnote48-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote48-appendix}{\hyperlink{endnote48-body}{WPN: ``ardent committed''}}}}}\makeatother \thinspace\fi to the holy life\\
...
\ifdigital\bottomNav{three-characteristics}\fi
...
\section{The Discourse on Loving-Kindness}
\label{words-on-loving-kindness}

\begin{leader-english}
  \anglebracketleft\ \hspace{-0.5mm}Now let us recite the discourse on loving-kindness \hspace{-0.5mm}\anglebracketright\
\end{leader-english}
...
\begin{english-only}
  ...
  Just\ifdigital\makeatletter\hyperlink{endnote49-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote49-appendix}{\hyperlink{endnote49-body}{WPN: ``Even''}}}}}\makeatother\fi
...
\ifdigital\bottomNav{sharing-merits-departed}\fi
...
\ifdigital
  \chapterOpeningPage{teachings_compressed_A5.jpg}
\else
  \chapterOpeningPage{teachings_A5.jpg}
\fi

\ifninebythirteen
  \chapterOpeningPage{teachings_9x13.png}
\fi

\ifbfive
  \chapterOpeningPage{teachings_B5.png}
\fi
...
\section{Turning the Wheel of Dhamma}
...
\begin{english}
  It is just this Noble Eightfold Path\ifdigital\makeatletter\hyperlink{endnote51-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote51-appendix}{\hyperlink{endnote51-body}{WPN: ``It is this Noble Eightfold Path''}}}}}\makeatother\fi
\end{english}
...
\begin{english}
  Sickness is dukkha\ifdigital\makeatletter\hyperlink{endnote52-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  In brief \breathmark\ the five aggregates of clinging are dukkha\ifdigital\makeatletter\hyperlink{endnote54-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-verses}
  ...
  \ifbfive\enlargethispage{1\baselineskip}\fi
  Light arose in me\ifdigital\makeatletter\hyperlink{endnote55-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote55-appendix}{\hyperlink{endnote55-body}{WPN: ``Light arose''}}}}}\makeatother\fi \\
...
\begin{english}
  This Noble Truth of dukkha\ifdigital\makeatletter\hyperlink{endnote56-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote56-appendix}{\hyperlink{endnote56-body}{WPN: ``Now this Noble Truth of \textit{dukkha}''}}}}}\makeatother\fi \\
...
\begin{english}
  This origin of dukkha\makeatletter\hyperlink{endnote167-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote167-appendix}{\hyperlink{endnote167-body}{While the Pāli includes the term \textit{ariya-saccaṁ} (``noble truth''), this clause has been omitted from the English translations of the second to fourth noble truths for the sake of brevity. As a positive side effect, this omission may inadvertently help prevent misunderstandings---specifically, the mistaken idea that one is to abandon the noble truth itself, rather than the cause of \textit{dukkha}. Clearly, it is the cause of \textit{dukkha}---namely, craving---that is to be abandoned, not the noble truth of \textit{dukkha} itself. This point becomes even clearer when considering the fourth noble truth, which is to be developed. This obviously refers to the factors of the Noble Eightfold Path, not to the truth as a doctrinal concept.}}}}}\makeatother\\
  Should be abandoned
\end{english}
...
\begin{english-verses}
  Bhikkhus as long as \ifdigital\makeatletter\hyperlink{endnote158-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-verses}
  But bhikkhus when \ifdigital\makeatletter\hyperlink{endnote159-appendix}\Hy@raisedlink{{\pagenote{%
...
\ifninebythirteen\vspace{-1em}\fi

\suttaRef{[SN 56.11]}

\ifdigital\bottomNav{true-false-refuges}\fi
...
\begin{leader-english}
  \anglebracketleft\ \hspace{-0.5mm}Now let us recite the Gradual Training{-0.5mm}\anglebracketright\
\end{leader-english}
...
\begin{english-only-justify}
  ``It is possible to describe a gradual training \breathmark\ gradual practice \breathmark\ and gradual progress in this Dhamma and Vinaya. When the Tathāgata obtains a person to be \mbox{tamed}~\breathmark\ he first disciplines him thus:
\end{english-only-justify}

\clearpage

\begin{english-only-justify}
  `Come bhikkhu be virtuous \breathmark\ dwell restrained by the \mbox{Pātimokkha}~\breathmark\ perfect in conduct and resort \breathmark\ and seeing danger in the slightest faults \breathmark\ train by undertaking the training rules.''
\end{english-only-justify}
...
\begin{english-only-justify}
  ``Having thus gone forth and possessing the bhikkhus' training and way of life \breathmark\ abandoning the destruction of \mbox{life}~\breathmark\ he abstains from destroying \mbox{life}~\breathmark\ with rod and weapon laid aside \breathmark\ conscientious \breathmark\ merciful \breathmark\ he abides compassionate to all living beings. Abandoning the taking of what is not given \breathmark\ he abstains from taking what is not given \breathmark\ taking only what is given \breathmark\ expecting only what is given \breathmark\ by not stealing he abides in purity.''
\end{english-only-justify}

\begin{english-only-justify}
  ``Abandoning the household life \breathmark\ he observes the holy life \breathmark\ living \mbox{apart}~\breathmark\ abstaining from the vulgar practice of sexual intercourse.''
\end{english-only-justify}

\linkdest{endnote59-body}
\begin{english-only-justify}
  ``Abandoning false speech \breathmark\ he abstains from false \mbox{speech}~\breathmark\ he speaks \mbox{truth}~\breathmark\ adheres to truth \breathmark\ is trustworthy and reliable \breathmark\ one who is no deceiver of the world. Abandoning malicious speech \breathmark\ he abstains from malicious speech \breathmark\ he does not repeat elsewhere what he has heard here \breathmark\ in order to divide those people\makeatletter\hyperlink{endnote59-appendix}\Hy@raisedlink{{\pagenote{%
  ...
  from these \breathmark\ nor does he repeat here what he has heard elsewhere \breathmark\ in order to divide these people from those \breathmark\ thus he is one who reunites those who are divided \breathmark\ a promoter of \mbox{friendships}~\breathmark\ who enjoys unity \breathmark\ rejoices in unity \breathmark\ delights in \mbox{unity}~\breathmark\ a speaker of words that promote unity. Abandoning harsh speech \breathmark\ he abstains from harsh \mbox{speech}~\breathmark\ he speaks words that are gentle \breathmark\ pleasing to the ear \breathmark\ and \mbox{loveable}~\breathmark\ that go to the heart \breathmark\ are \mbox{courteous}~\breathmark\ desired by many and agreeable to many. Abandoning idle \mbox{chatter}~\breathmark\ he abstains from idle \mbox{chatter}~\breathmark\ he speaks at the right time \breathmark\ speaks what is fact \breathmark\ speaks on what is \mbox{good}~\breathmark\ speaks on the Dhamma and Vinaya \breathmark\ at the right time \breathmark\ he speaks words that are worth recording \breathmark\ reasonable \breathmark\ moderate \breathmark\ and beneficial.''
\end{english-only-justify}
...
\begin{english-only-justify}
  ``He abstains from harming seeds and plants. He practices eating one meal a day \breathmark\ abstaining from eating at night and outside the proper time.\makeatletter\hyperlink{endnote148-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote148-appendix}{\hyperlink{endnote148-body}{The \textit{Vinaya} defines the wrong time for eating as from noon until dawnrise of the following day.}}}}}\makeatother\thinspace He abstains from \mbox{dancing}~\breathmark\ singing \breathmark\ music and seeing entertainments. He abstains from wearing \mbox{garlands}~\breathmark\ smartening himself with \mbox{scent}~\breathmark\ and embellishing himself with unguents. He abstains from high and luxurious sleeping places. He abstains from accepting gold and silver. He abstains from accepting raw grain. He abstains from accepting raw meat. He abstains from accepting women and girls. He abstains from accepting men and women slaves. He abstains from accepting goats and sheep. He abstains from accepting fowl and pigs. He abstains from accepting \mbox{elephants}~\breathmark\ cattle \breathmark\ horses and mares. He abstains from accepting fields and land.''
\end{english-only-justify}

\begin{english-only-justify}
  ``He abstains from running errands and messages. He abstains from buying and selling. He abstains from false weights \breathmark\ false metals \breathmark\ and false measures. He abstains from accepting bribes \breathmark\ deceiving \breathmark\ \mbox{defrauding}~\breathmark\ and trickery. He abstains from wounding \breathmark\ \mbox{murdering}~\breathmark\ \mbox{binding}~\breathmark\ \mbox{robbery}~\breathmark\ plunder and violence.''
\end{english-only-justify}

\begin{english-only-justify}
  ``He becomes content with robes to protect his body \breathmark\ and almsfood to maintain his stomach \breathmark\ and wherever he goes he sets out taking only these with him. Just as a bird \breathmark\ wherever it goes flies with its wings as its only burden \breathmark\ so too the bhikkhu becomes content with robes to protect his \mbox{body}~\breathmark\ and almsfood to maintain his \mbox{stomach}~\breathmark\ and wherever he goes he sets out taking only these with him. Possessing this aggregate of noble virtue \breathmark\ he experiences within himself a bliss that is blameless.''
\end{english-only-justify}

\suttaRef{[MN 51]}

\begin{english-only-justify}
  ``Then the Tathāgata disciplines him further: ``Come bhikkhu \breathmark\ guard the doors of your sense faculties. On seeing a form with the eye \breathmark\ do not grasp at its signs and features. Since if you were to leave the eye faculty unguarded \breathmark\ evil unwholesome states of longing and grief might invade \mbox{you}~\breathmark\ practice the way of its restraint \breathmark\ guard the eye faculty \breathmark\ undertake the restraint of the eye faculty. On hearing a sound with the ear. On smelling an odour with the nose. On tasting a flavour with the tongue. On touching a tangible with the body. On cognizing a mind-object with the \mbox{mind}~\breathmark\ do not grasp at its signs and features. Since if you were to leave the mind faculty \mbox{unguarded}~\breathmark\ evil unwholesome states of longing and grief might invade you \breathmark\ practice the way of its restraint \breathmark\ guard the mind faculty \breathmark\ undertake the restraint of the mind faculty.''
\end{english-only-justify}

\ifbfive\clearpage\fi

\begin{english-only-justify}
  ``Come bhikkhu \breathmark\ be moderate in eating. Wisely reflecting I use \mbox{almsfood}~\breathmark\ not for fun \breathmark\ not for pleasure \breathmark\ not for fattening \breathmark\ not for \mbox{beautification}~\breathmark\ only for the maintenance and nourishment of this \mbox{body}~\breathmark\ for keeping it healthy \breathmark\ for helping with the holy life \breathmark\ thinking thus: I will allay hunger without overeating \breathmark\ so that I may continue to live blamelessly and at ease.''
\end{english-only-justify}
...
\begin{english-only-justify}
  ``Come bhikkhu \breathmark\ be possessed of mindfulness and full awareness. Act in full awareness when going forward and returning \breathmark\ act in full awareness when looking ahead and looking away \breathmark\ act in full awareness when flexing and extending your limbs \breathmark\ act in full awareness when wearing your \mbox{robes}~\breathmark\ and carrying your outer robe and bowl \breathmark\ act in full awareness when \mbox{eating}~\breathmark\ drinking \breathmark\ consuming \mbox{food}~\breathmark\ and tasting \breathmark\ act in full awareness when defecating and urinating \breathmark\ act in full awareness when walking \breathmark\ \mbox{standing}~\breathmark\ sitting \breathmark\ falling \mbox{asleep}~\breathmark\ waking up\makeatletter\hyperlink{endnote60-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-only-justify}
  ``Come bhikkhu \breathmark\ resort to a secluded resting place: a \mbox{forest}~\breathmark\ the foot of a tree \breathmark\ a mountain \breathmark\ a ravine \breathmark\ a hillside \mbox{cave}~\breathmark\ a charnel ground \breathmark\ a jungle thicket \breathmark\ an open space \breathmark\ a heap of straw.''
\end{english-only-justify}
...
\begin{english-only-justify}
  ``After his meal on returning from almsround he sits \mbox{down}~\breathmark\ having crossed his legs \breathmark\ sets his body erect \breathmark\ having established mindfulness in front of him. Abandoning longing \ifdigital\makeatletter\hyperlink{endnote61-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote61-appendix}{\hyperlink{endnote61-body}{WPN: ``covetousness''}}}}}\makeatother\thinspace\fi
  for the \mbox{world}~\breathmark\ he abides with a mind free from longing \breathmark\ he purifies his mind from longing.
\end{english-only-justify}

\clearpage

\begin{english-only-justify}
Abandoning ill will and hatred \breathmark\ he abides with a mind free from ill will \breathmark\ compassionate for the welfare of all living \mbox{beings}~\breathmark\ he~purifies his mind from ill will and hatred. Abandoning sloth and torpor \breathmark\ he abides free from sloth and torpor \breathmark\ percipient of light \breathmark\ mindful and fully \mbox{aware}~\breathmark\ he purifies his mind from sloth and torpor. Abandoning restlessness and remorse \breathmark\ he abides unagitated \breathmark\ with a mind inwardly peaceful \breathmark\ he purifies his mind from restlessness and remorse. Abandoning \mbox{doubt}~\breathmark\ he abides having gone beyond doubt \breathmark\ unperplexed about wholesome states \breathmark\ he purifies his mind from doubt.''
\end{english-only-justify}
...
\begin{english-only-justify}
  ``After his meal on returning from almsround he sits \mbox{down}~\breathmark\ having crossed his legs \breathmark\ sets his body erect \breathmark\ having established mindfulness in front of him. Abandoning longing \ifdigital\makeatletter\hyperlink{endnote61-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote61-appendix}{\hyperlink{endnote61-body}{WPN: ``covetousness''}}}}}\makeatother\thinspace\fi
  for the \mbox{world}~\breathmark\ he abides with a mind free from longing \breathmark\ he purifies his mind from longing. Abandoning ill will and hatred \breathmark\ he abides with a mind free from ill will \breathmark\ compassionate for the welfare of all living \mbox{beings}~\breathmark\ he~purifies his mind from ill will and hatred. Abandoning sloth and torpor \breathmark\ he abides free from sloth and torpor \breathmark\ percipient of light \breathmark\ mindful and fully \mbox{aware}~\breathmark\ he purifies his mind from sloth and torpor. Abandoning restlessness and remorse \breathmark\ he abides unagitated \breathmark\ with a mind inwardly peaceful \breathmark\ he purifies his mind from restlessness and remorse. Abandoning \mbox{doubt}~\breathmark\ he abides having gone beyond doubt \breathmark\ unperplexed about wholesome states \breathmark\ he purifies his mind from doubt.''
\end{english-only-justify}

\suttaRef{[MN 107]}

\begin{english-only-justify}
  ``When these five hindrances are unabandoned in \mbox{himself}~\breathmark\ he sees them respectively as a debt \breathmark\ a disease \breathmark\ a \mbox{prison}~\breathmark\ \mbox{slavery}~\breathmark\ and a road across a desert. But when these five hindrances have been abandoned in \mbox{himself}~\breathmark\ he sees that as freedom from \mbox{debt}~\breathmark\ freedom from \mbox{disease}~\breathmark\ release from prison \breathmark\ freedom from slavery \breathmark\ and a land of safety. Considering thus he would be glad and full of joy.''
\end{english-only-justify}
...
\ifdigital\bottomNav{sharing-aspirations}\fi
...
\ifdigital\bottomNav{principles-of-non-decline}\fi
...
\ifdigital\bottomNav{words-on-loving-kindness}\fi
...
\begin{english}
  Having put away\\
  Longing and grief for the world\ifdigital\makeatletter\hyperlink{endnote62-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote62-appendix}{\hyperlink{endnote62-body}{WPN: ``covetousness and grief''}}}}}\makeatother\fi
\end{english}
...
\begin{english}
  He abides contemplating dhammas as dhammas\ifdigital\makeatletter\hyperlink{endnote63-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote63-appendix}{\hyperlink{endnote63-body}{WPN: ``He abides contemplating mind-objects as mind-objects.'' Since ``mind-object'' is not an ideal translation for ``\textit{dhamma}'' in this context, it is preferable to leave ``\textit{dhamma}'' untranslated here.}}}}}\makeatother\fi
\end{english}
...
\begin{english}
  And experiencing pleasure with the body\ifdigital\makeatletter\hyperlink{endnote65-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote65-appendix}{\hyperlink{endnote65-body}{WPN: ``Still feeling pleasure with the body.'' The Pāli doesn't say ``still'', but more importantly SN 48.40 states that physical pleasure (\textit{sukha}) has ceased in third Jhāna, and mental pleasure (\textit{somanassa}) has ceased in fourth Jhāna. Therefore, according to SN 48.40 \textit{kāya} in the context of the third Jhāna stock formula cannot refer to the physical body. The Pāli commentaries agree, and explain that ``\textit{kāya}'' here refers to the ``mental body'', in particular to mental pleasure (\textit{somanassa}). However, a comparative study by Prof. Kuan Tse-Fu titled \textit{``Clarification on Feelings in Buddhist Dhyāna/Jhāna Meditation''} brought to light that the Chinese parallel to SN 48.40 has a different sequence of disappearing types of \textit{vedanā} in the sequence of the four \textit{Jhānas}. While it would go beyond the scope of this footnote to discuss the matter in detail, it is noteworthy that the parallel to SN 48.40, the \textit{Aviparātaka Sūtra} of the \textit{Āgamas}, indeed mentions that bodily pleasant feeling (\textit{sukha}) disappears only in the fourth Jhāna, whereas mental pleasant feeling (\textit{somanassa}) has disappeared already in the third Jhāna, alongside with the disappearance of \textit{pīti}. In the context of this chanting book, we have therefore chosen to stay with the literal translation of the word ``\textit{kāya}'' as ``body'', and invite the reader to draw his own conclusions.}}}}}\makeatother\fi
\end{english}

Yaṁ taṁ ariyā ācikkhanti
\linkdest{endnote66-body}
\begin{pali-hang-together}
  `Upekkhako satimā sukha-vihārī'ti\ifdigital\makeatletter\hyperlink{endnote66-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  With the previous disappearance of joy and displeasure\ifdigital\makeatletter\hyperlink{endnote67-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote67-appendix}{\hyperlink{endnote67-body}{WPN: ``grief''}}}}}\makeatother\fi
\end{english}
...
\ifdigital\bottomNav{repulsiveness-of-food}\fi
...
\begin{english}
  ...
  `I shall breathe in tranquillizing the bodily formation'\ifdigital\makeatletter\hyperlink{endnote68-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote68-appendix}{\hyperlink{endnote68-body}{WPN: ``I shall breathe in tranquillising the bodily formations.'' \textit{Kāyasaṅkhāraṁ} is singular, not plural.}}}}}\makeatother\fi
\end{english}
...
\begin{english}
  ...
  `I shall breathe in tranquillizing the mental formation'\ifdigital\makeatletter\hyperlink{endnote70-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote70-appendix}{\hyperlink{endnote70-body}{WPN: ``I shall breathe in tranquillising the mental formation.'' \textit{Cittasaṅkhāraṁ} is singular, not plural.}}}}}\makeatother\fi
\end{english}
...
\ifdigital\bottomNav{discourse-on-blessings}\fi
...
\begin{leader}
  \anglebracketleft\ \hspace{-0.5mm}Handa mayaṁ paṭicca-samuppāda-vibhaṅgaṁ bhaṇāmase\makeatletter\hyperlink{endnote71-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-hang}
  Skillful volition of the sense-sphere \breathmark\ of the \mbox{form-sphere}~\breathmark\ connected with giving \breathmark\ connected with virtue \breathmark\ connected with meditation\makeatletter\hyperlink{endnote153-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-hang-verses}
  Feeling born of eye-contact \breathmark\ feeling born of \mbox{ear-contact}~\breathmark\
...
\begin{english-hang-verses}
  The ageing of various beings among the various classes of beings \breathmark\ their growing old \breathmark\ brokenness of teeth \breathmark\ greyness of hair \breathmark\ wrinkling of skin \breathmark\ decline of \mbox{vitality}~\breathmark\ decay of faculties
\end{english-hang-verses}
...
\begin{english-hang-verses}
  The passing away of various beings from the various classes of \mbox{beings}~\breathmark\ their perishing \breathmark\ breaking up \breathmark\ disappearance \breathmark\ dying \breathmark\ death \breathmark\ completion of time \breathmark\ breakup of the aggregates \breathmark\ laying down of the \mbox{carcass}~\breathmark\ cutting off the life faculty
\end{english-hang-verses}
...
\begin{english-hang-verses}
  The bodily discomfort \breathmark\ bodily pain \breathmark\ what is felt as uncomfortable \breathmark\ painful \breathmark\ that is born of \mbox{body-contact}~\breathmark\ the uncomfortable painful feeling that is born of body-contact
\end{english-hang-verses}
...
\begin{english-hang-verses}
  The mental discomfort \breathmark\ mental pain \breathmark\ what is felt as uncomfortable \breathmark\ painful \breathmark\ that is born of \mbox{mind-contact}~\breathmark\ the uncomfortable painful feeling that is born of mind-contact
\end{english-hang-verses}
...
\begin{english-hang}
  Such is the combination \breathmark\ composition \breathmark\ collocation \breathmark\ \ifbfive \mbox{manifestation}~\breathmark\ \else manifestation \breathmark\ \fi of this whole mass of suffering
\end{english-hang}
...
\ifdigital\bottomNav{dhamma-in-brief}\fi
...
\ifdigital\bottomNav{uddissanadhitthana}\fi
...
\ifdigital\bottomNav{patimokkha-exhortation}\fi
...
\begin{english-hang}
  Both in public and in private \breathmark\ with his spiritual companions
\end{english-hang}
...
\begin{english}
  Endowed with such a shared view he dwells
\end{english}
...
\ifdigital\bottomNav{protection}\fi
...
\sectionSubTitle{Dhamm'ānudhamma-padhāna}
\section{Striving According \mbox{to}~the~Dhamma}
\label{striving-according-to-dhamma}

\begin{leader}
  \anglebracketleft\ \hspace{-0.5mm}Handa mayaṁ dhamm’ānudhamma-padhāna-pāṭhaṁ bhaṇāmase \hspace{-0.5mm}\anglebracketright\
\end{leader}
...
\begin{english-verses}
  ...
  By manly effort\ifdigital\makeatletter\hyperlink{endnote87-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  Well withdrawn from evil \ifdigital\makeatletter\hyperlink{endnote88-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote88-appendix}{\hyperlink{endnote88-body}{WPN: omitted ``evil'' (\textit{pāpa}) in its translation.}}}}}\makeatother\fi
  unwholesome states
\end{english}
...
\begin{english}
  Bhikkhus this holy life is like cream from milk\ifdigital\makeatletter\hyperlink{endnote89-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote89-appendix}{\hyperlink{endnote89-body}{WPN: ``like the cream of the milk''; \textit{maṇḍapeyya} is a Pāli idiom, meaning ``of the best quality (lit. to be drunk like cream)''}}}}}\makeatother\fi
\end{english}
...
Avaṅkatā avañjhā \ifdigital\makeatletter\hyperlink{endnote90-appendix}\Hy@raisedlink{{\pagenote{%
      \hypertarget{endnote90-appendix}{\hyperlink{endnote90-body}{WPN: ``\textit{avaññā}''}}}}}\makeatother \thinspace\fi
bhavissati

\begin{english}
  Thinking thus:\\
  \linkdest{endnote91-body}
  ``Our going forth will not be crooked and barren\ifdigital\makeatletter\hyperlink{endnote91-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote91-appendix}{\hyperlink{endnote91-body}{WPN: ``thinking in such a way: our going forth will not be barren''}}}}}\makeatother\fi
\end{english}
...
\begin{english-verses}
  ...
  Supports for the sick and medicinal requisites\ifdigital\makeatletter\hyperlink{endnote92-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote92-appendix}{\hyperlink{endnote92-body}{WPN: ``And supports for the sick''}}}}}\makeatother\fi\\
...
Alam'eva appamādena sampādetun'ti\ifdigital\makeatletter\hyperlink{endnote93-appendix}\Hy@raisedlink{{\pagenote{%
      \hypertarget{endnote93-appendix}{\hyperlink{endnote93-body}{WPN: ``\textit{sampādetun}''}}}}}\makeatother\fi
...
\ifdigital\bottomNav{divine-abidings}\fi
...
\begin{english}
  Conditioned things are of ceasing nature\ifdigital\makeatletter\hyperlink{endnote94-appendix}\Hy@raisedlink{{\pagenote{%
...
\ifninebythirteen
  \chapterOpeningPage{reflections_9x13.png}
\fi

\ifbfive
  \chapterOpeningPage{reflections_B5.png}
\fi
...
\ifdigital\bottomNav{five-reflections}\fi
...
\ifdigital\bottomNav{requisites-for-awakening}\fi
...
\begin{english-verses}
  All beings are the owners of their kamma\ifdigital\makeatletter\hyperlink{endnote96-appendix}\Hy@raisedlink{{\pagenote{%
...
\ifdigital\bottomNav{seven-factors-of-awakening}\fi
...
\begin{english-hang}
  I will abide pervading one quarter with a heart imbued with empathetic joy\ifdigital\makeatletter\hyperlink{endnote97-appendix}\Hy@raisedlink{{\pagenote{%
...
\ifdigital\bottomNav{ten-reflections}\fi
...
\begin{english-verses}
  ...
  Of such acts \breathmark\ I will be the heir\ifdigital\makeatletter\hyperlink{endnote98-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  Thus we should frequently reflect\ifdigital\makeatletter\hyperlink{endnote146-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote146-appendix}{\hyperlink{endnote146-body}{WPN: ``recollect''}}}}}\makeatother\fi
\end{english}

\suttaRef{[AN 5.57]}

\ifdigital\bottomNav{32-parts}\fi
...
\begin{english-hang-verses}
  Bhikkhus there are these ten dhammas\ifdigital\makeatletter\hyperlink{endnote99-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-verses}
  ``I have reached a state of castelessness''\ifdigital\makeatletter\hyperlink{endnote100-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-verses}
  ``Now my conduct should be different from before''\ifdigital\makeatletter\hyperlink{endnote101-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-verses}
  \begin{english-hang-first-line}
  ``Could my wise spiritual companions\ifdigital\makeatletter\hyperlink{endnote165-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-verses}
  ...
  Of such acts \breathmark\ I will be the heir''\ifdigital\makeatletter\hyperlink{endnote102-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-verses}
  \begin{english-hang-first-line}
  ``Have I attained any superhuman state in knowledge and vision \breathmark\ worthy of the noble ones\ifdigital\makeatletter\hyperlink{endnote166-appendix}\Hy@raisedlink{{\pagenote{%
...
{\centering
  ...
  \begin{tabular}{ r l }
    pihakaṁ         & \tr{spleen} \\
    papphāsaṁ       & \tr{lungs} \\
    antaṁ           & \tr{intestines}\ifdigital\makeatletter\hyperlink{endnote152-appendix}\Hy@raisedlink{{\pagenote{%
                      \hypertarget{endnote152-appendix}{\hyperlink{endnote152-body}{WPN: ``bowels''}}}}}\fi \\
    antaguṇaṁ       & \tr{mesentery}\ifdigital\makeatletter\hyperlink{endnote153-appendix}\Hy@raisedlink{{\pagenote{%
...
\ifbfive\vspace{-0.4em}\fi
\suttaRef{[DN 22]}

\enlargethispage{\baselineskip\vspace{-1.0em}}
\ifdigital\bottomNav{principles-of-cordiality}\fi
...
\begin{english}
  All things are not-self\ifdigital\makeatletter\hyperlink{endnote104-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  Useless\ifdigital\makeatletter\hyperlink{endnote105-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  Their nature is to rise and cease\ifdigital\makeatletter\hyperlink{endnote106-appendix}\Hy@raisedlink{{\pagenote{%
...
\ifdigital\bottomNav{just-as-rivers}\fi
...
#+begin_src latex :tangle ./tex/recitations/cardinal-discourses.tex
...
#+begin_src latex :tangle ./tex/recitations/cardinal-discourses/dhammacakkappavattana.tex
...
** The Discourse on Turning the Wheel of Dhamma

#+begin_src latex :tangle ./tex/recitations/cardinal-discourses/dhammacakkappavattana-eng.tex
...
\begin{english-only-hang}
  On one occasion the Blessed One was dwelling at Benares \breathmark\ in the Deer Park at Isipatana. There he addressed the bhikkhus of the group of five thus:
\end{english-only-hang}

\begin{english-only-hang}
  Bhikkhus these two extremes should not be followed \breathmark\ by one who has gone forth into homelessness. What two? The pursuit of sensual happiness in sensual pleasures \breathmark\ which is low \breathmark\ vulgar \breathmark\ the way of worldlings \breathmark\ ignoble \breathmark\ unbeneficial \breathmark\ and the pursuit of \mbox{self-mortification}~\breathmark\ which is painful \breathmark\ ignoble \breathmark\ unbeneficial
\end{english-only-hang}

\begin{english-only-hang}
  Without veering towards either of these extremes \breathmark\ the Tathāgata has awakened to the Middle Way \breathmark\ which gives rise to \ifbfive \mbox{vision}~\breathmark\ \else vision \breathmark\ \fi which gives rise to knowledge \breathmark\ which leads to \mbox{peace}~\breathmark\ to direct knowledge \breathmark\ to enlightenment \breathmark\ to Nibbāna
\end{english-only-hang}

\begin{english-only-hang}
  And what bhikkhus \breathmark\ is the Middle Way awakened to by the Tathāgata \breathmark\ which gives rise to vision \breathmark\ which gives rise to knowledge \breathmark\  which leads to peace \breathmark\ to direct knowledge \breathmark\ to enlightenment \breathmark\ to Nibbāna
\end{english-only-hang}
...
\begin{english-only-hang}
  This bhikkhus is that Middle Way awakened to by the Tathāgata \breathmark\ which gives rise to vision \breathmark\ which gives rise to knowledge \breathmark\ which leads to peace \breathmark\ to direct \mbox{knowledge}~\breathmark\ to enlightenment \breathmark\ to Nibbāna
\end{english-only-hang}

\begin{english-only-hang}
  Now this bhikkhus \breathmark\ is the noble truth of suffering: birth is suffering \breathmark\ ageing is suffering \breathmark\ illness is suffering \breathmark\ death is \ifbfive \mbox{suffering}~ \else suffering \breathmark\ \fi union with what is displeasing is suffering \breathmark\ separation from what is pleasing is suffering \breathmark\ not to get what one wants is suffering \breathmark\ in brief \breathmark\ the five aggregates subject to clinging are suffering
\end{english-only-hang}

\begin{english-only-hang}
  Now this bhikkhus \breathmark\ is the noble truth of the origin of suffering: it is this craving  which leads to renewed \mbox{existence}~\breathmark\ accompanied by delight and lust \breathmark\ seeking delight here and there \breathmark\ that is craving for sensual pleasures \breathmark\ craving for existence \breathmark\ craving for extermination
\end{english-only-hang}

\ifninebythirteen\clearpage\fi

\begin{english-only-hang}
  Now this bhikkhus \breathmark\ is the noble truth of the cessation of suffering: it is the remainderless fading away and cessation\breathmark\ of that same craving the giving up and relinquishing of it \breathmark\ freedom from it \breathmark\ non-reliance on it
\end{english-only-hang}

\begin{english-only-hang}
  Now this bhikkhus \breathmark\ is the noble truth of the way leading to the cessation of suffering: It is this Noble Eightfold Path
\end{english-only-hang}
...
\begin{english-only-hang}
  `This is the noble truth of suffering': thus bhikkhus in regard to things unheard before \breathmark\ there arose in me \mbox{vision}~\breathmark\ knowledge \breathmark\ wisdom \breathmark\ true knowledge \breathmark\ and light
\end{english-only-hang}

\begin{english-only-hang}
  `This noble truth of suffering is to be fully understood': thus bhikkhus in regard to things unheard before \breathmark\ there arose in me vision \breathmark\ knowledge \breathmark\ wisdom \breathmark\ true knowledge \breathmark\ and light
\end{english-only-hang}

\begin{english-only-hang}
  `This noble truth of suffering has been fully understood': thus bhikkhus in regard to things unheard before \breathmark\ there arose in me vision \breathmark\ \mbox{knowledge}~\breathmark\ wisdom \breathmark\ true knowledge \breathmark\ and light
\end{english-only-hang}

\ifbfive\clearpage\fi

\begin{english-only-hang}
  `This is the noble truth of the origin of suffering': thus bhikkhus in regard to things unheard before \breathmark\ there arose in me vision \breathmark\ knowledge \breathmark\ \mbox{wisdom}~\breathmark\ true knowledge \breathmark\ and light
\end{english-only-hang}

\begin{english-only-hang}
  `This noble truth of the origin of suffering is to be abandoned': thus bhikkhus in regard to things unheard before \breathmark\ there arose in me vision \breathmark\ knowledge \breathmark\ wisdom \breathmark\ true knowledge \breathmark\ and light
\end{english-only-hang}

\begin{english-only-hang}
  `This noble truth of the origin of suffering has been abandoned': thus bhikkhus in regard to things unheard before \breathmark\ there arose in me vision \breathmark\ knowledge \breathmark\ wisdom \breathmark\ true knowledge \breathmark\ and light
\end{english-only-hang}
...
\begin{english-only-hang}
  So long bhikkhus as my knowledge and vision \breathmark\ of these Four Noble \mbox{Truths}~\breathmark\ as they really are \breathmark\ in their three phases and twelve aspects \breathmark\ was not entirely purified \breathmark\ in this way I did not claim to have awakened to the unsurpassed perfect enlightenment \breathmark\ in this world with its devas \breathmark\ Māra and Brahmā \breathmark\ in this generation with its ascetics and brahmins \breathmark\ its devas and humans
\end{english-only-hang}

\begin{english-only-hang}
  But when my knowledge and vision \breathmark\ of these Four Noble \mbox{Truths}~\breathmark\ as they really are \breathmark\ in their three phases and twelve aspects \breathmark\ was entirely \mbox{purified}~\breathmark\ in this way then I claimed to have awakened to the unsurpassed perfect enlightenment \breathmark\ in this world with its devas \breathmark\ Māra and Brahmā \breathmark\ in this generation with its ascetics and brahmins \breathmark\ its devas and humans
\end{english-only-hang}
...
\begin{english-only-hang}
  ``At Benares in the Deer Park at Isipatana \breathmark\ this unsurpassed Wheel of the Dhamma \breathmark\ has been set in motion by the Blessed One \breathmark\ which cannot be stopped by any ascetic or brahmin \breathmark\ or deva or Māra or Brahmā or by anyone in the world''
\end{english-only-hang}
...
\begin{english-only-hang}
  Having heard the cry of the Paranimmita-vasavattī \mbox{devas}~\breathmark\ the devas of Brahmā's company raised a cry:
\end{english-only-hang}
...
\begin{english-only-hang}
  Thus at that moment \breathmark\ at that instant \breathmark\ at that second \breathmark\ the cry spread as far as the brahmā world \breathmark\ and this ten thousandfold world system \mbox{shook}~\breathmark\ quaked \breathmark\ and trembled \breathmark\ and an immeasurable glorious radiance appeared in the world \breathmark\ surpassing the divine majesty of the devas
\end{english-only-hang}
...
#+begin_src latex :tangle ./tex/recitations/cardinal-discourses/anattalakkhana.tex
...
\begin{pali-hang}
  Ekaṁ samayaṁ bhagavā bārāṇasiyaṁ viharati isipatane \ifafive migadāye \breathmark\ \else \mbox{migadāye}~\breathmark\ \fi Tatra kho bhagavā pañca-vaggiye bhikkhū āmantesi: {``Bhikkhavo''ti}~\breathmark\ ``Bhadante''ti te bhikkhū bhagavato paccassosuṁ \breathmark\ Bhagavā etad'avoca\makeatletter\hyperlink{endnote107-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{pali-hang}
  Saññā anattā \breathmark\ saññā ca h'idaṁ bhikkhave attā abhavissa \breathmark\ na'y'idaṁ saññā ābādhāya \mbox{saṁvatteyya}~\breathmark\ labbhetha ca \ifbfive \mbox{saññāya}~\breathmark\ \else saññāya \breathmark\ \fi ``Evaṁ me saññā hotu \breathmark\ evaṁ me saññā mā ahosī''ti
\end{pali-hang}
\begin{pali-hang-together}
...
\begin{pali-hang}
  Viññāṇaṁ anattā \breathmark\ viññāṇañ'ca h'idaṁ bhikkhave attā \ifbfive \mbox{abhavissa}~\breathmark\ \else abhavissa\breathmark\ \fi na'y'idaṁ viññāṇaṁ ābādhāya saṁvatteyya \breathmark\ labbhetha ca \mbox{viññāṇe}~\breathmark\ ``Evaṁ me viññāṇaṁ hotu \breathmark\ evaṁ me viññāṇaṁ mā ahosī''ti
\end{pali-hang}
\begin{pali-hang-together}
...
\begin{pali-hang}
  Ye keci saṅkhārā atīt'ānāgata-paccuppannā \breathmark\ ajjhattā vā bahiddhā \mbox{vā}~\breathmark\ oḷārikā vā sukhumā vā \breathmark\ hīnā vā paṇītā \mbox{vā}~\breathmark\ ye dūre santike \mbox{vā}~\breathmark\ sabbe saṅkhārā: \breathmark\ \ifninebythirteen\clearpage\fi ``N'etaṁ mama n'eso'ham'asmi na m'eso attā''ti \breathmark\ evam'etaṁ yathā-bhūtaṁ sammappaññāya daṭṭhabbaṁ
\end{pali-hang}
...
\ifdigital\bottomNav{striving-according-to-dhamma}\fi
...
#+begin_src latex :tangle ./tex/recitations/cardinal-discourses/anattalakkhana-eng.tex

\ifbfive

\section{The Discourse on the Characteristic \mbox{of}~Not-Self}
...
\ifdigital\bottomNav{exposition-on-burning}\fi

#+end_src

** Āditta-pariyāya-sutta

#+begin_src latex :tangle ./tex/recitations/cardinal-discourses/adittapariyaya.tex
...
\begin{pali-hang}
  Sotaṁ ādittaṁ \breathmark\ saddā ādittā \breathmark\ sota-viññāṇaṁ \mbox{ādittaṁ}~\breathmark\ sota-samphasso āditto \breathmark\ yam'p'idaṁ sota-samphassa-paccayā uppajjati vedayitaṁ \breathmark\ sukhaṁ vā dukkhaṁ vā adukkham'asukhaṁ vā tam'pi ādittaṁ
\end{pali-hang}
\ifninebythirteen\clearpage\fi
\begin{pali-hang-together}
  Kena ādittaṁ?
...
\end{leader-pali}
\begin{pali-hang-together}
  Sutavā ariyasāvako cakkhusmim'pi nibbindati \breathmark\ rūpesu'pi nibbindati~\breathmark\ cakkhu-viññāṇe'pi \mbox{nibbindati}~\breathmark\ cakkhu-samphasse'pi nibbindati~\breathmark\ yam'p'idaṁ cakkhu-samphassa-paccayā uppajjati vedayitaṁ \breathmark\ sukhaṁ vā dukkhaṁ vā adukkham'asukhaṁ vā \ifninebythirteen\enlargethispage{1\baselineskip}\fi tasmim'pi nibbindati
\end{pali-hang-together}
...
\begin{pali-hang}
  Kāyasmim'pi nibbindati \breathmark\ phoṭṭhabbesu'pi \mbox{nibbindati}~\breathmark\ kāya-viññāṇe'pi nibbindati \breathmark\ kāya-samphasse'pi nibbindati \breathmark\ yam'p'idaṁ kāya-samphassa-paccayā uppajjati vedayitaṁ \breathmark\ sukhaṁ vā dukkhaṁ vā adukkham'asukhaṁ vā tasmim'pi nibbindati
\end{pali-hang}
...
\ifdigital\bottomNav{burdens}\fi

#+end_src

** The Discourse on the Exposition on Burning

#+begin_src latex :tangle ./tex/recitations/cardinal-discourses/adittapariyaya-eng.tex
...
\begin{english-only-hang}
  On one occasion\makeatletter\hyperlink{endnote113-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote113-appendix}{\hyperlink{endnote113-body}{The entire original version of the English translation has been replaced.}}}}}\makeatother\thinspace the Blessed One was dwelling at Gayā \breathmark\ at Gayā's \mbox{Head}~\breathmark\ together with a thousand bhikkhus \breathmark\ There he addressed the bhikkhus:
\end{english-only-hang}
...
\ifdigital\bottomNav{gradual-training}\fi
...
\ifninebythirteen
  \chapterOpeningPage{thanksgiving_recitations_9x13.png}
\fi

\ifbfive
  \chapterOpeningPage{thanksgiving_recitations_B5.png}
\fi
...
\begin{english}
  Likewise what's been given here\ifdigital\makeatletter\hyperlink{endnote114-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  Benefits the departed ones\ifdigital\makeatletter\hyperlink{endnote115-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english}
  With all the power of the Buddha\ifdigital\makeatletter\hyperlink{endnote169-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote169-appendix}{\hyperlink{endnote169-body}{WPN: ``Through the power of all Buddhas/Dhammas/Saṅghas'' The phrase ``\textit{Sabba-buddh'ānubhāvena}''—and similarly \textit{dhamm'ānubhāvena} and \textit{saṅgh'ānubhāvena}—can refer to the Triple Gem in either the singular or plural. However, compounds like these do not make that distinction explicit. While the evocation of ``by the power of all Buddhas'' (past, present, and future) is plausible, it is less fitting to read dhamm'ānubhāvena as ``by the power of all dhammas (phenomena),'' or \textit{saṅgh'ānubhāvena} as ``by the power of all communities.'' Therefore, the preferred reading is ``with all the power of the Buddha/Dhamma/Saṅgha'' in the singular—evoking the unique spiritual potency of the Triple Gem.}}}}}\makeatother\fi
\end{english}
...
\ifninebythirteen\vspace{0.25em}\fi
...
\begin{verses}
  ...
  Sukhañ'ca paṭibhānakaṁ\ifdigital\makeatletter\hyperlink{endnote123-appendix}\Hy@raisedlink{{\pagenote{%
...
\ifbfive\enlargethispage{1.2\baselineskip}\fi
  Arogā sukhitā hotha\\
...
** Verses from the Discourse on Confidence in the Supreme

#+begin_src latex :tangle ./tex/recitations/thanksgiving-recitations.tex

\sectionSubTitle{Aggappasāda-sutta-gāthā}
\ifninebythirteen
\section[Verses from the Discourse on Confidence\\ in the Supreme]{Verses from the Discourse \mbox{on}~Confidence~in~the~Supreme}
  \else
...
** Verses from the Discourse on Giving at the Proper Time

#+begin_src latex :tangle ./tex/recitations/thanksgiving-recitations.tex

\sectionSubTitle{Kāla-dāna-sutta-gāthā}
\ifninebythirteen
\section[Verses from the Discourse on Giving\\ at the Proper Time]{Verses from the Discourse on Giving at the Proper Time}
  \else
...
\ifdigital
  \chapterOpeningPage{protective_recitations_compressed_A5.jpg}
\else
  \chapterOpeningPage{protective_recitations_A5.jpg}
\fi

\ifninebythirteen
  \chapterOpeningPage{protective_recitations_9x13.png}
\fi

\ifbfive
  \chapterOpeningPage{protective_recitations_B5.png}
\fi
...
\ifafive\vspace{-0.5em}\fi
\ifninebythirteen\vspace{-0.8em}\fi
\ifbfive\vspace{-0.2em}\fi
...
\begin{leader-pharitvana}
  ...
  \ifbfive\mbox{Bhummā c'āyantu devā jala-thala-visame yakkha-gandhabba-nāgā}\\\else Bhummā c'āyantu devā jala-thala-visame yakkha-gandhabba-nāgā\\\fi
  \ifbfive\mbox{Tiṭṭhantā santike yaṁ muni-vara-vacanaṁ sādhavo me suṇantu}\\\else Tiṭṭhantā santike yaṁ muni-vara-vacanaṁ sādhavo me suṇantu\\\fi
  ...
  Saṅgha-payirupāsana-kālo ayam'bhadantā\ifdigital\makeatletter\hyperlink{endnote126-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{leader-pharitvana-english}
  Kind, venerable sirs: having spread thoughts \ifninebythirteen \\ \else \fi of good will,\\
  \ifninebythirteen\mbox{Recite the protective chant with undistracted mind.}\\\else Recite the protective chant with undistracted mind.\\\fi
  Those in the heavens of sensuality \& form,\\
  On peaks \& mountain precipices,\ifninebythirteen\\\else\fi in palaces floating in the sky,\\
  In islands, countries, \& towns,\\
  In groves of trees \& thickets,\\
  Around homesites \& fields.\\
  \ifbfive\mbox{And the earth-devas, spirits, heavenly minstrels, \& nāgas who are nearby,}\\\else And the earth-devas, spirits, heavenly minstrels,\\ \& nāgas who are nearby,\\\fi
...
\ifafive\clearpage\fi
  ...
  \ifninebythirteen
  \mbox{This is the time to listen to the Dhamma, venerable sirs.}\\
  \mbox{This is the time to attend to the Saṅgha, venerable sirs.}
  \else
...
** Passage on Preliminary Paying of Homage
...
\begin{pali-hang-together}
  \anglebracketleft\ \hspace{-0.5mm}Namo tassa \hspace{-0.5mm}\anglebracketright\ bhagavato arahato \ifninebythirteen\\ \fi sammāsambuddhassa \hfill{[3x]}
\end{pali-hang-together}
...
** Verses on Triumph by Paying Homage
...
** The Discourse on the Loving-Kindness to be Done
...
** Qualities of the Buddha, Dhamma, and Saṅgha

#+begin_src latex :tangle ./tex/recitations/protective-recitations.tex

\sectionSubTitle{Buddha-dhamma-saṅgha-guṇā}
\section{Qualities of the Buddha, \mbox{Dhamma,}~and~Saṅgha}
...
\begin{english-verses}
  The Dhamma is well-expounded by the Blessed One,\\
  \begin{english-hang-together}
  \ifninebythirteen Directly visible, immediate, inviting one to  come and see,\else Directly visible, immediate, inviting one to  come and see,\fi\\
  \end{english-hang-together}
...
\begin{pali-hang-continued}
  ...
  Osadhaṁ \ifdigital\makeatletter\hyperlink{endnote127-appendix}\Hy@raisedlink{{\pagenote{%
...
\ifninebythirteen \vspace{-0.35cm} \suttaRef{[MJG]} \else \suttaRef{[MJG]} \fi

#+end_src

** Protection of the Factors of Awakening
...
\ifafive \vspace{-0.4em} \fi

\suttaRef{[Trad]}

#+end_src

** Verses on Dismissing Evil Spirits
...
\begin{pali-hang-continued}
  ...
  Sabbe devā anumodantu\ifdigital\makeatletter\hyperlink{endnote128-appendix}\Hy@raisedlink{{\pagenote{%
...
** Verses on the Eight Victory Blessings
...
\begin{pali-hang-continued}
  ...
  Paṇīdhi te padakkhiṇe\ifdigital\makeatletter\hyperlink{endnote130-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-verses}
  May every blessing come to be.\\
  And all good spirits guard you well.\\
  With all the power of the Buddha,\ifdigital\makeatletter\hyperlink{endnote168-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote168-appendix}{\hyperlink{endnote168-body}{WPN: ``Through the power of all Buddhas/Dhammas/Saṅghas'' The phrase ``\textit{Sabba-buddh'ānubhāvena}''—and similarly \textit{dhamm'ānubhāvena} and \textit{saṅgh'ānubhāvena}—can refer to the Triple Gem in either the singular or plural. However, compounds like these do not make that distinction explicit. While the evocation of ``by the power of all Buddhas'' (past, present, and future) is plausible, it is less fitting to read dhamm'ānubhāvena as ``by the power of all dhammas (phenomena),'' or \textit{saṅgh'ānubhāvena} as ``by the power of all communities.'' Therefore, the preferred reading is ``with all the power of the Buddha/Dhamma/Saṅgha'' in the singular—evoking the unique spiritual potency of the Triple Gem.}}}}}\makeatother\fi\\
  May you always be at ease.
\end{english-verses}
...
\begin{english-verses}
  May every blessing come to be.\\
  And all good spirits guard you well.\\
  \ifbfive\enlargethispage{2\baselineskip}\fi
  \ifafive\clearpage\fi
  With all the power of the Saṅgha,\\
  May you always be at ease.
\end{english-verses}

\ifbfive\vspace{-0.25cm}\fi
...
\ifdigital
  \chapterOpeningPage{funeral_recitations_compressed_A5.jpg}
\else
  \chapterOpeningPage{funeral_recitations_A5.jpg}
\fi

\ifninebythirteen
  \chapterOpeningPage{funeral_recitations_9x13.png}
\fi

\ifbfive
  \chapterOpeningPage{funeral_recitations_B5.png}
\fi
...
** Outlines from the Enumeration of Phenomena

#+begin_src latex :tangle ./tex/recitations/funeral-recitations.tex

\sectionSubTitle{Dhamma-saṅgaṇī-mātikā}
\section{Outlines from the Enumeration of Phenomena}
\label{enumeration-of-phenomena}
...
** Passage on the Ground for Distinct Seeing
...
\begin{pali-hang-continued}
  Aṭṭhārasa dhātuyo:
  \begin{pali-hang}
    Cakkhu-dhātu rūpa-dhātu cakkhu-viññāṇa-dhātu sota-dhātu sadda-dhātu sota-viññāṇa-dhātu ghāna-dhātu gandha-dhātu ghāna-viññāṇa-dhātu \ifafive\clearpage\fi jivhā-dhātu rasa-dhātu jivhā-viññāṇa-dhātu kāya-dhātu phoṭṭhabba-dhātu kāya-viññāṇa-dhātu mano-dhātu dhamma-dhātu mano-viññāṇa-dhātu
  \end{pali-hang}
\end{pali-hang-continued}
...
\begin{pali-hang-continued}
  Bā-vīsat'indriyāni:\makeatletter\hyperlink{endnote131-appendix}\Hy@raisedlink{{\pagenote{%
        \hypertarget{endnote131-appendix}{\hyperlink{endnote131-body}{While these faculties are mentioned as a set of 22 only in the Abhidhamma Vibhaṅga, all of them are also found within the discourses.}}}}}\makeatother
  \begin{pali-hang}
...
** Passage on the List from the Foundation of Conditional Relations

#+begin_src latex :tangle ./tex/recitations/funeral-recitations.tex

\sectionSubTitle{Paṭṭhāna-mātikā-pāṭho}
\section[Passage on the Outlines from the Foundation\\ of Conditional Relations]{Passage on the Outlines from the Foundation of Conditional Relations}
\label{foundation-of-conditional-relations}
...
\begin{english-hang-verses}
  Root condition, sense-object condition, predominant condition, immediate condition, directly immediate condition, coexistent condition, reciprocity condition, dependence condition, sufficing condition, pre-existent condition, post-existent condition, repetition condition, action condition, result condition, nutriment condition, faculty condition, jhāna condition, path condition, \ifninebythirteen\clearpage\fi associated condition, separated condition, existence condition, non-existence condition, disappeared condition, non-dissappeared condition.
\end{english-hang-verses}
...
** Verses Starting with ``He Gave to Me''
...
\begin{english-verses}
  ...
  Their nature is to rise and cease;\ifdigital\makeatletter\hyperlink{endnote132-appendix}\Hy@raisedlink{{\pagenote{%
...
\ifdigital\bottomNav{recollection-of-impermanence}\fi
...
\ifninebythirteen
  \chapterOpeningPage{sharing_of_merits_9x13.png}
\fi

\ifbfive
  \chapterOpeningPage{sharing_of_merits_B5.png}
\fi
...
\ifdigital\bottomNav{closing-homage}\fi
...
\begin{english}
  ...
  \ifninebythirteen\begin{english-hang-inline}\fi
  ...
  \ifninebythirteen\end{english-hang-inline}\fi
  ...
  \ifninebythirteen\end{english-hang-inline}\clearpage\fi
...
\ifdigital\bottomNav{sharing-merits-devas}\fi
...
\mbox{Yo kho bhikkhu vā bhikkhunī vā upāsako vā upāsikā vā}
...
\begin{pali-hang}
Namo tassa bhagavato arahato \mbox{sammāsambuddhassa}~\hfill{[3x]}
\end{pali-hang}
...
\ifninebythirteen \smallskip \else \fi
...
\begin{english-hang}
  I undertake the training\ifdigital\makeatletter\hyperlink{endnote139-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-hang}
  I undertake the training to refrain from consuming intoxicating\ifninebythirteen \else \\ \fi
  \linkdest{endnote140-body}
  drink and drugs that lead to carelessness.\ifdigital\makeatletter\hyperlink{endnote140-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-hang}
  I undertake the training to refrain from consuming intoxicating drink and drugs that\ifdigital\makeatletter\hyperlink{endnote141-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-hang}
  I undertake the training to refrain from eating after noon.\ifdigital\makeatletter\hyperlink{endnote142-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-hang}
  I undertake the training to refrain from dancing, singing, music and seeing entertainments; from wearing garlands, using perfumes, and beautifying the body with cosmetics.\ifdigital\makeatletter\hyperlink{endnote143-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{english-verses}
  ...
  Therefore let virtue be purified.\ifdigital\makeatletter\hyperlink{endnote144-appendix}\Hy@raisedlink{{\pagenote{%
...
\begin{sidewaystable}
  \hspace*{-0.35cm}
    \begin{tblr}{
        colspec={l *{11}{c}},
        hlines, vlines,
        rowsep=3pt,  % Adjusted vertical padding
        colsep=2pt,  % Adjusted horizontal padding
        row{1-5}={font=\fontsize{8.5}{8.5}\selectfont}, % Adjusted font size
      ...
      \SetCell[c=1]{c}Gutturals  & k & kh & g & gh & ṅ & h  &   & a & ā & e & \\
      \SetCell[c=1]{c}Palatals   & c & ch & j & jh & ñ & y  &   & i & ī & \SetCell[r=3]{}  & \\
      \SetCell[c=1]{c}Cerebrals  & ṭ & ṭh & ḍ & ḍh & ṇ & r\,/\,l\,/\,ḷh & & \SetCell[r=2]{} & \SetCell[r=2]{} & & ṁ \\
      \SetCell[c=1]{c}Dentals    & t & th & d & dh & n & l  & s &   &   &   &     \\
      \SetCell[c=1]{c}Labials    & p & ph & b & bh & m & v  &   & u & ū & o &     \\
    \end{tblr}
\end{sidewaystable}
...
\vspace{0.25em}
    ...
    \begin{tblr}{
        colspec={l *{11}{c}},
        hlines, vlines,
        rowsep=0.25pt,  % Adjusted vertical padding
        colsep=2.475pt,  % Adjusted horizontal padding
...
\vspace{0.5em}
  ...
  \begin{tblr}{
    colspec={l *{11}{c}},
    hlines, vlines,
    rowsep=0.05pt,  % Adjusted vertical padding
    colsep=2.68pt,  % Adjusted horizontal padding
...
\ifafive\vspace{0.25cm}\fi
% \ifninebythirteen\vspace{-0.5cm}\fi
\ifbfive\vspace{0.25cm}\fi
...
%% \ifninebythirteen\vspace{-0.25cm}\fi
\ifafive\vspace{-0.75cm}\fi
\ifbfive\vspace{-0.2cm}\fi

\ifafive\medskip\subsection*{\textcolor{sbs-brown}{Vowels}}\fi
\ifninebythirteen\subsection*{Vowels}\fi
\ifbfive\subsection*{Vowels}\fi
...
{%
  ...
  \ifafive\fontsize{11}{17}\selectfont\fi%
  \ifninebythirteen\fontsize{8}{11}\selectfont\fi%
  \ifbfive\fontsize{13.5}{20}\selectfont\fi%

  \setlength{\parindent}{0pt}%
  \raggedright\label{copyright-details}%
  \ifafive\setlength{\parskip}{4.5pt}\fi%
  \ifninebythirteen\setlength{\parskip}{2.5pt}\fi%
  \ifbfive\setlength{\parskip}{6.5pt}\fi%

  {\centering

    \ifafive{\fontsize{25}{18}\selectfont \ccbyncnd}\fi
    \ifninebythirteen{\fontsize{18}{10}\selectfont \ccbyncnd}\fi
    \ifbfive{\fontsize{40}{20}\selectfont \ccbyncnd}\fi
